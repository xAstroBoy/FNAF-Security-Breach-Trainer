...
struct FText UWI_Timer_C::Update_Timer_Display()
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.Update Timer Display");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.LaserHit");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.ForceKill");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.GameStart");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.GameExit");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.PlayerHit");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.UpdateTime");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.GameEnd");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.ShowTimer");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.HideTimer");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Timer.WI_Timer_C.ExecuteUbergraph_WI_Timer");
