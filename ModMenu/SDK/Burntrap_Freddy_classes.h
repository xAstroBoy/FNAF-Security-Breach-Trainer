...
// 0x0069 (FullSize[0x0981] - InheritedSize[0x0918])
...
public:
	...
	unsigned char                                      UnknownData_LOPI[0x3];                                     // 0x0929(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HWV3[0x3];                                     // 0x093D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Burntrap_Freddy.Burntrap_Freddy_C");
		return ptr;
	}
	...
	void FirstHack();
	void Use_Chica_Beak();
	void ExecuteUbergraph_Burntrap_Freddy(int EntryPoint);
};
