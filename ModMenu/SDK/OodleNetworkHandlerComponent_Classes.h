...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4IJ7[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WPKT[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (PADDING)
