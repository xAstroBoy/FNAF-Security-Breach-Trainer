...
namespace CG
{
	...
	public:
		...
		unsigned char                                              EndSequence[0x28];                                       // 0x0328(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
		...
		unsigned char                                              UnknownData_BWWT[0x5];                                   // 0x0353(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              HideSpot[0x28];                                          // 0x0358(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
