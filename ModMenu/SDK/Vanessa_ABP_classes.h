...
// 0x31D4 (FullSize[0x343C] - InheritedSize[0x0268])
class UVanessa_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_H054[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_3LW6[0x8];                                     // 0x23C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G2W9[0x3];                                     // 0x2B4D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5IT7[0x4];                                     // 0x2B54(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAnimNode_LinkedAnimGraph                   AnimGraphNode_LinkedAnimGraph;                             // 0x2B58(0x00A0)
	unsigned char                                      UnknownData_8ETL[0x8];                                     // 0x2BF8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6V5O[0x3];                                     // 0x32C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RWBI[0x3];                                     // 0x32CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OC8E[0x3];                                     // 0x3329(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                AlertLevel;                                                // 0x3338(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                ScanVariation;                                             // 0x333C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int                                                RandomRunSelector;                                         // 0x3344(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                RandomWalkSelector;                                        // 0x3348(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_0QY3[0x4];                                     // 0x334C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L2AU[0x2];                                     // 0x338A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AY9Q[0x2];                                     // 0x3392(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                HidingSpaceType;                                           // 0x3394(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_LDNT[0x2];                                     // 0x339A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<AnimatronicModeEnum_EAnimatronicModeEnum> AnimationMode;                                             // 0x33B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_CGF3[0x7];                                     // 0x33B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IDV3[0x7];                                     // 0x33C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FName                                       Tightest_Profile;                                          // 0x33D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FName                                       Tight_Profile;                                             // 0x33D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FName                                       Default_Profile;                                           // 0x33E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_ISPU[0x2];                                     // 0x33EA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E6XV[0x3];                                     // 0x33F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B4YO[0x3];                                     // 0x33F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I275[0x3];                                     // 0x3409(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YVTJ[0x3];                                     // 0x341D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1MFI[0x1];                                     // 0x342F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XL7P[0x3];                                     // 0x3435(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Vanessa_ABP.Vanessa_ABP_C");
		return ptr;
	}
	...
	bool Perform_Scan_Trace(bool IsRight, TEnumAsByte<Engine_EDrawDebugTrace> DrawDebugType);
	void Perform_Foot_IK(bool IsRightFoot, TEnumAsByte<Engine_EDrawDebugTrace> DrawDebugType);
	void OnNotifyEnd_4DA5BD5F44BC73B8F401CBAC20AA502C(const struct FName& NotifyName);
	void OnNotifyBegin_4DA5BD5F44BC73B8F401CBAC20AA502C(const struct FName& NotifyName);
	void OnInterrupted_4DA5BD5F44BC73B8F401CBAC20AA502C(const struct FName& NotifyName);
	void OnBlendOut_4DA5BD5F44BC73B8F401CBAC20AA502C(const struct FName& NotifyName);
	void OnCompleted_4DA5BD5F44BC73B8F401CBAC20AA502C(const struct FName& NotifyName);
	...
	void ExecuteUbergraph_Vanessa_ABP(int EntryPoint);
};
