...
namespace CG
{
	...
	void UActorNavDistance_C::ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ActorNavDistance.ActorNavDistance_C.ReceiveTickAI");
	...
	void UActorNavDistance_C::ReceiveActivationAI(class AAIController* OwnerController, class APawn* ControlledPawn)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ActorNavDistance.ActorNavDistance_C.ReceiveActivationAI");
	 ...
	 */
	void UActorNavDistance_C::UpdateDistance(class AActor* InputPin)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ActorNavDistance.ActorNavDistance_C.Update Distance");
		
		UActorNavDistance_C_UpdateDistance_Params params {};
	 ...
	 */
	void UActorNavDistance_C::ExecuteUbergraph_ActorNavDistance(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ActorNavDistance.ActorNavDistance_C.ExecuteUbergraph_ActorNavDistance");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UActorNavDistance_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UActorNavDistance_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass ActorNavDistance.ActorNavDistance_C");
		return ptr;
	}
