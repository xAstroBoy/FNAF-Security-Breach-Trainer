...
public:
	...
	TMap<struct FName, class UDebugInventoryItem_C*>   InventoryItems;                                            // 0x0558(0x0050) (Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass DebugUI.DebugUI_C");
		return ptr;
	}
	...
	struct FText TimeFloatToText(float InputPin);
	float TimeTextToFloat(const struct FText& InText);
	...
	struct FText Get_CameraFOV_Text_1();
	...
	struct FText Get_SetFreddyPower_Text_1();
	float Get_FlyingSpeed_Value_1();
	struct FText Get_PowerLevelInput_Text_1();
	struct FText Get_SecurityLevel_Text_1();
	...
	void BndEvt__FlyingCollisionType_K2Node_ComponentBoundEvent_1_OnSelectionChangedEvent__DelegateSignature(const struct FString& SelectedItem, TEnumAsByte<SlateCore_ESelectInfo> SelectionType);
	...
	void BndEvt__ClockTime_K2Node_ComponentBoundEvent_12_OnEditableTextBoxCommittedEvent__DelegateSignature(const struct FText& Text, TEnumAsByte<SlateCore_ETextCommit> CommitMethod);
	...
	void BndEvt__SecurityLevel_K2Node_ComponentBoundEvent_20_OnEditableTextBoxCommittedEvent__DelegateSignature(const struct FText& Text, TEnumAsByte<SlateCore_ETextCommit> CommitMethod);
	void BndEvt__PowerLevelInput_K2Node_ComponentBoundEvent_22_OnEditableTextBoxCommittedEvent__DelegateSignature(const struct FText& Text, TEnumAsByte<SlateCore_ETextCommit> CommitMethod);
	...
	void BndEvt__SetFreddyPower_K2Node_ComponentBoundEvent_23_OnEditableTextBoxCommittedEvent__DelegateSignature(const struct FText& Text, TEnumAsByte<SlateCore_ETextCommit> CommitMethod);
	...
	void BndEvt__CameraFOV_K2Node_ComponentBoundEvent_39_OnEditableTextBoxChangedEvent__DelegateSignature(const struct FText& Text);
	...
	void BndEvt__TextBox_FazerBlastTime_K2Node_ComponentBoundEvent_49_OnEditableTextBoxCommittedEvent__DelegateSignature(const struct FText& Text, TEnumAsByte<SlateCore_ETextCommit> CommitMethod);
	void OnInitialized();
	void BndEvt__InventorySearchText_K2Node_ComponentBoundEvent_11_OnEditableTextBoxChangedEvent__DelegateSignature(const struct FText& Text);
