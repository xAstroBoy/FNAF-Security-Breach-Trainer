...
// 0x0680 (FullSize[0x08E8] - InheritedSize[0x0268])
class UVanessaAim_Abp_LINK_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_E19T[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_GE0L[0x2];                                     // 0x08D6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass VanessaAim_Abp_LINK.VanessaAim_Abp_LINK_C");
		return ptr;
	}
