...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FindNextPoint.FindNextPoint_C.Find Next Point");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FindNextPoint.FindNextPoint_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FindNextPoint.FindNextPoint_C.ExecuteUbergraph_FindNextPoint");
