...
public:
	...
	unsigned char                                      UnknownData_P4VJ[0x2];                                     // 0x01F2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ECollisionChannel>              ObstructionCollisionChannel;                               // 0x01F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_34RR[0xB7];                                    // 0x01F9(0x00B7) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J842[0x6];                                     // 0x026A(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4UUE[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
// 0x001C (FullSize[0x020C] - InheritedSize[0x01F0])
class UAkAcousticTextureSetComponent : public USceneComponent
{
public:
	unsigned char                                      UnknownData_SDTA[0x1C];                                    // 0x01F0(0x001C) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_BZ3L[0x2E];                                    // 0x023A(0x002E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J7QR[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_M7K7[0x48];                                    // 0x0028(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JZNJ[0x3C];                                    // 0x002C(0x003C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_76LO[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QNQX[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OUJQ[0x28];                                    // 0x0100(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SPW4[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SX6A[0x28];                                    // 0x0230(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_25VZ[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EYCD[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5N9F[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z3CS[0x8];                                     // 0x0208(0x0008) MISSED OFFSET (PADDING)
...
// 0x01D0 (FullSize[0x03E0] - InheritedSize[0x0210])
...
public:
	...
	unsigned char                                      UnknownData_PDC5[0x7];                                     // 0x0211(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_300L[0x3];                                     // 0x0219(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4HWI[0x3];                                     // 0x021D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FString                                     EarlyReflectionAuxBusName;                                 // 0x0230(0x0010) (Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int                                                EarlyReflectionOrder;                                      // 0x0240(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	int                                                diffractionMaxEdges;                                       // 0x0250(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int                                                diffractionMaxPaths;                                       // 0x0254(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	unsigned char                                      UnknownData_3RB6[0x3];                                     // 0x025D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J4W0[0x3];                                     // 0x0261(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AJEZ[0x173];                                   // 0x026D(0x0173) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EZSN[0x30];                                    // 0x03E0(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_P1F8[0x390];                                   // 0x0120(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4JAY[0x3];                                     // 0x04B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UFNJ[0x4];                                     // 0x04C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XCV4[0x6];                                     // 0x0A4A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1XVB[0x50];                                    // 0x0AD0(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_PFTC[0x58];                                    // 0x0060(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	void STATIC_ResetRTPCValue(class UAkRtpc* RTPCValue, int InterpolationTimeMs, class AActor* Actor, const struct FName& RTPC);
...
{
public:
	unsigned char                                      UnknownData_KA7N[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NY0Y[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6U7P[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
// 0x0184 (FullSize[0x0390] - InheritedSize[0x020C])
...
public:
	...
	unsigned char                                      UnknownData_EDD1[0x4];                                     // 0x0214(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_29P1[0x7];                                     // 0x0281(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WEGI[0x10];                                    // 0x0290(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkGeometryData                             GeometryData;                                              // 0x02A0(0x0050) (NativeAccessSpecifierPrivate)
	TMap<int, float>                                   SurfaceAreas;                                              // 0x02F0(0x0050) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_UJO1[0x50];                                    // 0x0340(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4M1R[0x14];                                    // 0x0054(0x0014) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_P4L9[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettingsWithSampleRate CommonSettings;                                            // 0x0030(0x0068) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;                                     // 0x0098(0x0028) (Edit, Config, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_F6ST[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	TArray<struct FString>                             AvailableAudioCultures;                                    // 0x0050(0x0010) (Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_G292[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettingsWithSampleRate CommonSettings;                                            // 0x0030(0x0068) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkAudioSession                             AudioSession;                                              // 0x0098(0x000C) (Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_FZUV[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0CKF[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4RX8[0x20];                                    // 0x0128(0x0020) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnSelectionChanged;                                        // 0x0108(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FScriptMulticastDelegate                    OnPropertyDragged;                                         // 0x0118(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6129[0x20];                                    // 0x0128(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YHZ4[0x3];                                     // 0x01F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QE4P[0x7];                                     // 0x0201(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FString                                     AuxBusName;                                                // 0x0210(0x0010) (Edit, BlueprintVisible, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HJSG[0x8];                                     // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HZQH[0x50];                                    // 0x0230(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V781[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettingsWithSampleRate CommonSettings;                                            // 0x0030(0x0068) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;                                     // 0x0098(0x0028) (Edit, Config, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_H9YB[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettingsWithSampleRate CommonSettings;                                            // 0x0030(0x0068) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;                                     // 0x0098(0x0028) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkAdvancedInitializationSettingsWithMultiCoreRendering AdvancedSettings;                                          // 0x00C0(0x0030) (Edit, Config, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
...
public:
	...
	unsigned char                                      UnknownData_PNCB[0x36];                                    // 0x002A(0x0036) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BZMN[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UObject*>                             UserData;                                                  // 0x0030(0x0010) (Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_KODJ[0x10];                                    // 0x0048(0x0010) MISSED OFFSET (PADDING)
...
// 0x0060 (FullSize[0x00B8] - InheritedSize[0x0058])
class UAkExternalMediaAsset : public UAkMediaAsset
{
public:
	unsigned char                                      UnknownData_W3Q7[0x60];                                    // 0x0058(0x0060) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class AkAudio.AkPlatformInitialisationSettingsBase");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_NQTC[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_XF8A[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettings             CommonSettings;                                            // 0x0030(0x0060) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;                                     // 0x0090(0x0028) (Edit, Config, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_VYY1[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_R5Y5[0x7];                                     // 0x0261(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L30B[0x4];                                     // 0x028C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_S31O[0x3];                                     // 0x0211(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N5Y9[0x3];                                     // 0x0215(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J26Q[0xB];                                     // 0x0225(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LNCI[0x8];                                     // 0x0238(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0SAH[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F858[0x5];                                     // 0x0053(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OSBW[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q3I9[0x4];                                     // 0x024C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     CommandletCommitMessage;                                   // 0x0250(0x0010) (Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<struct FString, struct FString>               UnrealCultureToWwiseCulture;                               // 0x0260(0x0050) (Edit, Config, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_5MI2[0x4];                                     // 0x02B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TIWS[0x8];                                     // 0x02D8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_T68R[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AHFC[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2XSH[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CHQC[0x3];                                     // 0x0461(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9V9O[0x2];                                     // 0x0486(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AT4T[0x3];                                     // 0x048D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YCLG[0x20];                                    // 0x0510(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4FCG[0x48];                                    // 0x0418(0x0048) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class AkAudio.AkSubmixInputComponent");
		return ptr;
	}
...
// 0x0034 (FullSize[0x0240] - InheritedSize[0x020C])
class UAkSurfaceReflectorSetComponent : public UAkAcousticTextureSetComponent
{
public:
	unsigned char                                      UnknownData_V6AI[0x4];                                     // 0x020C(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_I95J[0x7];                                     // 0x0221(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C4BJ[0x10];                                    // 0x0230(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SD4F[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettingsWithSampleRate CommonSettings;                                            // 0x0030(0x0068) (Edit, Config, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_JS5B[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettingsWithSampleRate CommonSettings;                                            // 0x0030(0x0068) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkAudioSession                             AudioSession;                                              // 0x0098(0x000C) (Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_39CK[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;                                     // 0x00A8(0x0028) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkAdvancedInitializationSettings           AdvancedSettings;                                          // 0x00D0(0x002C) (Edit, Config, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_LU18[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OAJI[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettingsWithSampleRate CommonSettings;                                            // 0x0030(0x0068) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;                                     // 0x0098(0x0028) (Edit, Config, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_Q050[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettingsWithSampleRate CommonSettings;                                            // 0x0030(0x0068) (Edit, Config, NativeAccessSpecifierPublic)
	struct FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;                                     // 0x0098(0x0028) (Edit, Config, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_38S3[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GEV9[0x20];                                    // 0x0128(0x0020) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnSelectionChanged;                                        // 0x0108(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FScriptMulticastDelegate                    OnItemDragged;                                             // 0x0118(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_K44K[0x40];                                    // 0x0128(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JG0Y[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettings             CommonSettings;                                            // 0x0030(0x0060) (Edit, Config, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_IIGX[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YZQ0[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettings             CommonSettings;                                            // 0x0030(0x0060) (Edit, Config, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_XWAO[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W5BO[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAkCommonInitializationSettings             CommonSettings;                                            // 0x0030(0x0060) (Edit, Config, NativeAccessSpecifierPublic)
...
public:
	...
	unsigned char                                      UnknownData_QTO6[0x7];                                     // 0x00A1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_78W1[0x7];                                     // 0x00A1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AOR2[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
public:
	float                                              LastUpdatePosition;                                        // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_0APE[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9Q07[0x40];                                    // 0x00E0(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TS5K[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4QYY[0x7];                                     // 0x0131(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IV29[0x20];                                    // 0x0148(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PYA5[0x4];                                     // 0x016C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     MaxDurationSourceID;                                       // 0x0170(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_YIJS[0x48];                                    // 0x0180(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DO3J[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BQSR[0x60];                                    // 0x0040(0x0060) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    Completed;                                                 // 0x0030(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_XNQG[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
