...
namespace CG
{
	...
	{
	public:
		StaffbotJob_Anim_EStaffbotJob_Anim                         Bot_Type;                                                // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
