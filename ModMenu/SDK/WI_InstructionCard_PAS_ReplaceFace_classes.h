...
// WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_ReplaceFace.WI_InstructionCard_PAS_ReplaceFace_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_ReplaceFace.WI_InstructionCard_PAS_ReplaceFace_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_ReplaceFace(int EntryPoint);
};
