...
// 0x00C7 (FullSize[0x0168] - InheritedSize[0x00A1])
class UPlayerInViewService_C : public USightDetectionService_C
{
public:
	unsigned char                                      UnknownData_WDYR[0x7];                                     // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4KEY[0x3];                                     // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6JN4[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PlayerInViewService.PlayerInViewService_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PlayerInViewService(int EntryPoint);
};
