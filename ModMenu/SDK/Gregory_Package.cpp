...
namespace CG
{
	 ...
	 */
	void AGregory_C::On_Item_Removed(const class FName& ItemName, const struct FFNAFInventoryTableStruct& InventoryItemInfo)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FFNAFInventoryTableStruct                   InventoryItemInfo                                          (BlueprintVisible, BlueprintReadOnly, Parm)
	 */
	void AGregory_C::On_Item_Collected(const class FName& ItemName, const struct FFNAFInventoryTableStruct& InventoryItemInfo)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	...
	void AGregory_C::StunInRange()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Gregory.Gregory_C.StunInRange");
	...
	void AGregory_C::InpActEvt_Run_K2Node_InputActionEvent_3(const struct FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Gregory.Gregory_C.InpActEvt_Run_K2Node_InputActionEvent_3");
	...
	void AGregory_C::InpActEvt_CallFreddy_K2Node_InputActionEvent_1(const struct FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Gregory.Gregory_C.InpActEvt_CallFreddy_K2Node_InputActionEvent_1");
	 ...
	 */
	void AGregory_C::OnFailure_D277383849041D09D51CF2BB341D6125(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		int                                                WrittenUserTag                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void AGregory_C::OnSuccess_D277383849041D09D51CF2BB341D6125(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		int                                                WrittenUserTag                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void AGregory_C::OnFailure_DCAEB8064AAF100FF80986844E21FAAA(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		int                                                WrittenUserTag                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void AGregory_C::OnSuccess_DCAEB8064AAF100FF80986844E21FAAA(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	...
	void AGregory_C::InpAxisEvt_MoveForward_K2Node_InputAxisEvent_2(float AxisValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Gregory.Gregory_C.InpAxisEvt_MoveForward_K2Node_InputAxisEvent_2");
	...
	void AGregory_C::Peek(const struct FTransform& PeekPoint, const struct FTransform& HideLocation, float Axis_Value)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Gregory.Gregory_C.Peek");
	 ...
	 */
	void AGregory_C::Held_Item_Instructions(const class FName& Name)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Function:
	 * 		Offset -> 0x00000000
	 * 		Name   -> PredefindFunction AGregory_C.StaticClass
