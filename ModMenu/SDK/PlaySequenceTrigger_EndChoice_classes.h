...
// 0x00E8 (FullSize[0x0479] - InheritedSize[0x0391])
class APlaySequenceTrigger_EndChoice_C : public APlaySequenceTrigger_C
{
public:
	unsigned char                                      UnknownData_40FA[0x7];                                     // 0x0391(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AQ9C[0x7];                                     // 0x0409(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CV0Q[0x7];                                     // 0x0419(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PlaySequenceTrigger_EndChoice.PlaySequenceTrigger_EndChoice_C");
		return ptr;
	}
	...
	void OnFailure_7F2250294461044CDA36CD9C7D00F0D9(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_7F2250294461044CDA36CD9C7D00F0D9(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnTriggered();
