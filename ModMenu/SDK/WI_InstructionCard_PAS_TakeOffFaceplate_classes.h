...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_TakeOffFaceplate.WI_InstructionCard_PAS_TakeOffFaceplate_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_TakeOffFaceplate(int EntryPoint);
};
