...
struct FClothCollisionPrim_Box
{
	...
	unsigned char                                      UnknownData_KMHL[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothCollisionPrim_Convex
{
	...
	unsigned char                                      UnknownData_9W5S[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
