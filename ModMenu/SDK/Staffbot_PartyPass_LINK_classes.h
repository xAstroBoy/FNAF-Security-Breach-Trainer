...
// 0x0DB6 (FullSize[0x101E] - InheritedSize[0x0268])
class UStaffbot_PartyPass_LINK_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_0AU5[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Staffbot_PartyPass_LINK.Staffbot_PartyPass_LINK_C");
		return ptr;
	}
