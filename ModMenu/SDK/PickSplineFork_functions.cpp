...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PickSplineFork.PickSplineFork_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PickSplineFork.PickSplineFork_C.ExecuteUbergraph_PickSplineFork");
