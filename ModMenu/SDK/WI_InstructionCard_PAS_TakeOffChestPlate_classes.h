...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_TakeOffChestPlate.WI_InstructionCard_PAS_TakeOffChestPlate_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_TakeOffChestPlate(int EntryPoint);
};
