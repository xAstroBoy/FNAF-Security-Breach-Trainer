...
namespace CG
{
	...
	{
	public:
		EFNAFQualityCommands                                       QualityCommand_2_7AD4F910458809DFF96F8595CDD201C9;       // 0x0000(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_B6ZP[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
