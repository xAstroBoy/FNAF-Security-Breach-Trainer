...
// 0x0BF8 (FullSize[0x0E20] - InheritedSize[0x0228])
...
public:
	...
	unsigned char                                      UnknownData_JP36[0x4];                                     // 0x06BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DA40[0x7];                                     // 0x06F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0NG6[0x4];                                     // 0x0724(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7438[0x4];                                     // 0x077C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HUG6[0x7];                                     // 0x0829(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UIKY[0x3];                                     // 0x0B81(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3ULH[0x7];                                     // 0x0B89(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       MontyOpenArm;                                              // 0x0B90(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       Monty_Close_Arm;                                           // 0x0BA8(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       MontyRemoveOldClaws;                                       // 0x0BC0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       ChicaRemoveBowtie;                                         // 0x0BD8(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       ChicaRemoveChest;                                          // 0x0BF0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       ChicaReplaceBowtie;                                        // 0x0C08(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       ChicaReplaceChest;                                         // 0x0C20(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       ChicaRemoveVoicebox;                                       // 0x0C38(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       RoxyOpenFace;                                              // 0x0C50(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       RoxyCloseFace;                                             // 0x0C68(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       RoxyRemoveEyes;                                            // 0x0C80(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       RoxyReplaceEyes;                                           // 0x0C98(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_XY2C[0x3];                                     // 0x0CF1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y8JZ[0x4];                                     // 0x0CFC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZZ4D[0x7];                                     // 0x0D69(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WD71[0x7];                                     // 0x0D79(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IPJU[0x2];                                     // 0x0DAE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CJXL[0x7];                                     // 0x0DB9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PS_Upgrade_And_Test_BP.PS_Upgrade_And_Test_BP_C");
		return ptr;
	}
