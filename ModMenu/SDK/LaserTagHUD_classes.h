...
public:
	...
	unsigned char                                      UnknownData_OFWE[0x3];                                     // 0x0291(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FText                                       GameOverUIText;                                            // 0x0298(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass LaserTagHUD.LaserTagHUD_C");
		return ptr;
	}
	...
	struct FText Get_CurrentScore();
	struct FText GameOver_Text();
	UMG_ESlateVisibility Get_CrossHairLaserGun_Visibility();
	struct FText Get_CountdownLaserTag_CountdownTimer();
