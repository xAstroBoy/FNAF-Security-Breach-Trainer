...
{
	struct FText                                       Text_2_41CFCA0B4E2F00DB7D8E1A80028361FB;                   // 0x0000(0x0018) (Edit, BlueprintVisible)
	...
	struct FString                                     Source_14_51F67308477EFDE491C591A9193D2EC4;                // 0x0020(0x0010) (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_R19D[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
