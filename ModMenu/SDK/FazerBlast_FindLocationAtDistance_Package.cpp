...
namespace CG
{
	...
	void UFazerBlast_FindLocationAtDistance_C::SetBlackBoardKeys(const struct FVector& TargetLocation, const struct FVector& PlayerLocation)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FazerBlast_FindLocationAtDistance.FazerBlast_FindLocationAtDistance_C.SetBlackBoardKeys");
	...
	struct FVector UFazerBlast_FindLocationAtDistance_C::GetBestLocation(class APawn** ControlledPawn, TArray<class AActor*>* ActorsToIgnore, struct FVector* PlayerLocation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FazerBlast_FindLocationAtDistance.FazerBlast_FindLocationAtDistance_C.GetBestLocation");
	...
	void UFazerBlast_FindLocationAtDistance_C::NavRays_Score(class APawn* ControlledPawn, const struct FVector& InDirection, const struct FVector& InStart, TArray<struct FVector>* NavRay_Ends, struct FVector* ReturnBestLocation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FazerBlast_FindLocationAtDistance.FazerBlast_FindLocationAtDistance_C.NavRays_Score");
	...
	void UFazerBlast_FindLocationAtDistance_C::NavRays_Correct(const struct FVector& InDirection, const struct FVector& InStart, TArray<struct FVector>* InNavRay_Ends, TArray<class AActor*> ActorsToIgnore, struct FVector* OutDirection, struct FVector* OutStart, TArray<struct FVector>* OutNavRay_Ends)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FazerBlast_FindLocationAtDistance.FazerBlast_FindLocationAtDistance_C.NavRays_Correct");
	...
	void UFazerBlast_FindLocationAtDistance_C::NavRays_Cast(class APawn* ControlledPawn, TArray<class AActor*>* ActorsToIgnore, struct FVector* Direction, struct FVector* Start, TArray<struct FVector>* NavRay_Ends)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FazerBlast_FindLocationAtDistance.FazerBlast_FindLocationAtDistance_C.NavRays_Cast");
	...
	void UFazerBlast_FindLocationAtDistance_C::Process(class APawn** ControlledPawn)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FazerBlast_FindLocationAtDistance.FazerBlast_FindLocationAtDistance_C.Process");
	...
	void UFazerBlast_FindLocationAtDistance_C::ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FazerBlast_FindLocationAtDistance.FazerBlast_FindLocationAtDistance_C.ReceiveExecuteAI");
	...
	void UFazerBlast_FindLocationAtDistance_C::ExecuteUbergraph_FazerBlast_FindLocationAtDistance(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FazerBlast_FindLocationAtDistance.FazerBlast_FindLocationAtDistance_C.ExecuteUbergraph_FazerBlast_FindLocationAtDistance");
	 ...
	 * Function:
	 * 		Offset -> 0x00000000
	 * 		Name   -> PredefindFunction UFazerBlast_FindLocationAtDistance_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UFazerBlast_FindLocationAtDistance_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass FazerBlast_FindLocationAtDistance.FazerBlast_FindLocationAtDistance_C");
		return ptr;
	}
