...
public:
	...
	struct FScriptMulticastDelegate                    OnOptionSelected;                                          // 0x02B8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, BlueprintAssignable, BlueprintCallable)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass InvertControlsUI.InvertControlsUI_C");
		return ptr;
	}
