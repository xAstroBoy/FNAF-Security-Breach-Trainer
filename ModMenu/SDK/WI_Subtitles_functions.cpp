...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.ToggleSubtitleVisibility");
...
void UWI_Subtitles_C::PrintDebug(const struct FString& String)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.PrintDebug");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.UpdateDisplay");
...
//		struct FString                                     CharStart                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
//		struct FString                                     CharEnd                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
//		struct FString                                     Variable                                                   (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash)
//		struct FString                                     String                                                     (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash)
void UWI_Subtitles_C::ExtractSubtitleVariable(const struct FString& SourceString, const struct FString& CharStart, const struct FString& CharEnd, struct FString* Variable, struct FString* String)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.ExtractSubtitleVariable");
...
void UWI_Subtitles_C::BeginVoiceOverDisplay(const struct FString& Key, class AActor* Actor, const struct FString& FallbackSourceString, float FallbackDuration, float MaxRadiusPercent, bool SanitizeKey, bool HighPriority)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.BeginVoiceOverDisplay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.TickDistance");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.TickLines");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.ToggleActive");
...
//		Flags  -> (Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
//		struct FS_SubtitleState                            ReturnValue                                                (Parm, OutParm, ReturnParm, HasGetValueTypeHash)
struct FS_SubtitleState UWI_Subtitles_C::GetSubtitleState()
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.GetSubtitleState");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.SetSubtitleState");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.Reset Lines");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.PreConstruct");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.Construct");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.Tick");
...
void UWI_Subtitles_C::EndVoiceOverDisplay(const struct FString& reason)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.EndVoiceOverDisplay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.SetEndTimer");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.EndTimer");
...
void UWI_Subtitles_C::ExecuteUbergraph_WI_Subtitles(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_Subtitles.WI_Subtitles_C.ExecuteUbergraph_WI_Subtitles");
