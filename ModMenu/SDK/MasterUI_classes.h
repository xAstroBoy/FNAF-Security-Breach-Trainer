...
namespace CG
{
	 ...
	 * Size -> 0x0129 (FullSize[0x0359] - InheritedSize[0x0230])
	 */
	...
	public:
		...
		class FText                                                Hours;                                                   // 0x0328(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
		class FText                                                Minutes;                                                 // 0x0340(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
