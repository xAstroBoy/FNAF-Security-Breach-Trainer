...
// 0x0B50 (FullSize[0x0DB8] - InheritedSize[0x0268])
class UTentacle_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_GKXQ[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_M70E[0x1];                                     // 0x0D53(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IY9K[0x3];                                     // 0x0D7D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JBI0[0x3];                                     // 0x0D85(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       BoneName;                                                  // 0x0D88(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_PW80[0x4];                                     // 0x0DAC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Tentacle_ABP.Tentacle_ABP_C");
		return ptr;
	}
