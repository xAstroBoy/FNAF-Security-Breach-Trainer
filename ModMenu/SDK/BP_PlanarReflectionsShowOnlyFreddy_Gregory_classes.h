...
namespace CG
{
	 ...
	 */
	class ABP_PlanarReflectionsShowOnlyFreddyGregory_C : public AActor
	{
	public:
		...
		TArray<class AActor*>                                      AllowedReflectiveMeshes;                                 // 0x0240(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance
	...
	public:
		...
		void SetRefelection(bool bNewVisibility);
		void ExecuteUbergraph_BP_PlanarReflectionsShowOnlyFreddyGregory(int32_t EntryPoint);
