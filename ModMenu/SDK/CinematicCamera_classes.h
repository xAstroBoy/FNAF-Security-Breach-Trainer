...
public:
	...
	unsigned char                                      UnknownData_P84Q[0x2];                                     // 0x0236(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_V0L2[0x3];                                     // 0x022D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_2N7V[0x10];                                    // 0x07F0(0x0010) MISSED OFFSET (PADDING)
...
// 0x0100 (FullSize[0x08B0] - InheritedSize[0x07B0])
...
public:
	...
	unsigned char                                      UnknownData_01YX[0xC];                                     // 0x0844(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FString                                     DefaultFilmbackPresetName;                                 // 0x0870(0x0010) (ZeroConstructor, Config, Deprecated, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FString                                     DefaultFilmbackPreset;                                     // 0x0880(0x0010) (ZeroConstructor, Config, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FString                                     DefaultLensPresetName;                                     // 0x0890(0x0010) (ZeroConstructor, Config, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	unsigned char                                      UnknownData_A23G[0x8];                                     // 0x08A8(0x0008) MISSED OFFSET (PADDING)
