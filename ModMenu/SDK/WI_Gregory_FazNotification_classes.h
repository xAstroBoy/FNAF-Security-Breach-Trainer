...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_Gregory_FazNotification.WI_Gregory_FazNotification_C");
		return ptr;
	}
	...
	void NewMissionAdded(const struct FName& MissionName, const struct FFNAFMissionState& MissionState, const struct FFNAFMissionInfo& MissionInfo);
	void MissionUpdated(const struct FName& MissionName, const struct FFNAFMissionState& MissionState, const struct FFNAFMissionInfo& MissionInfo);
	void Construct();
	void EnemyOnCamera(class ASecurityCamera* SecurityCamera);
	void Lost_Sight(class ASecurityCamera* SecurityCamera);
	void NewUnreadMessage(const struct FName& MessageName, const struct FFNAFMessageTableStruct& MessageInfo);
