...
// 0x781D (FullSize[0x7A85] - InheritedSize[0x0268])
class UAnimatronicJiggleABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_9L7F[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_NH8U[0x8];                                     // 0x5038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3GJC[0x8];                                     // 0x5958(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_937K[0x8];                                     // 0x6CB8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q7YW[0x8];                                     // 0x7208(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_STDA[0x8];                                     // 0x74C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass AnimatronicJiggleABP.AnimatronicJiggleABP_C");
		return ptr;
	}
