...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function RotationThresholdGeneral.RotationThresholdGeneral_C.ReceiveTick
	 */
	struct URotationThresholdGeneral_C_ReceiveTick_Params
	{
	public:
	 ...
	 */
	struct URotationThresholdGeneral_C_ExecuteUbergraph_RotationThresholdGeneral_Params
	{
	public:
