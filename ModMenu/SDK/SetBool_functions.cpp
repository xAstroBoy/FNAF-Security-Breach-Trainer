...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetBool.SetBool_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetBool.SetBool_C.ExecuteUbergraph_SetBool");
