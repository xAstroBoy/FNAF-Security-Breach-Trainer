...
namespace CG
{
	 ...
	 */
	struct AVanny_C_OnJumpscare_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_UHP4[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function Vanny.Vanny_C.BndEvt__Vanny_AutoAlertVolume_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature
	 */
	struct AVanny_C_BndEvt__Vanny_AutoAlertVolume_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params
	{
	public:
		...
		unsigned char                                              UnknownData_EP83[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_RYN8[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
