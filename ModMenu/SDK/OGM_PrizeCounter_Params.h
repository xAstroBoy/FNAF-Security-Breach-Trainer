...
namespace CG
{
	...
	{
	public:
		TArray<class ABP_DoorMaster_C*>                            DoorsFromOGM;                                            // 0x0000(0x0010)  (Parm, OutParm, HasGetValueTypeHash)
	 ...
	 */
	struct AOGM_PrizeCounter_C_On_Skip_Params
	{
	};
	 ...
	 */
	struct AOGM_PrizeCounter_C_Set_Lights_Params
	{
	public:
	...
	public:
		...
		bool                                                       Set_AI;                                                  // 0x0002(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 ...
	 */
	struct AOGM_PrizeCounter_C_On_Start_Params
	{
	};
