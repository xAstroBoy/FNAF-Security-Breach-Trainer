...
// 0x0C60 (FullSize[0x0EC8] - InheritedSize[0x0268])
class URIG_BallBlaster_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_2CF6[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_NI5Q[0x7];                                     // 0x0E99(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      BrokenMEsh[0x28];                                          // 0x0E99(0x0028) UNKNOWN PROPERTY: SoftObjectProperty


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass RIG_BallBlaster_ABP.RIG_BallBlaster_ABP_C");
		return ptr;
	}
