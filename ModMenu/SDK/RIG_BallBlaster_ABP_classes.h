...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_10LI[0x7];                                   // 0x0E99(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_RIG_BallBlaster_ABP(int32_t EntryPoint);
