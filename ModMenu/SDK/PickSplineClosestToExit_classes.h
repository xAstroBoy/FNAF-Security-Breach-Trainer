...
public:
	...
	unsigned char                                      UnknownData_DYPH[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PickSplineClosestToExit.PickSplineClosestToExit_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PickSplineClosestToExit(int EntryPoint);
};
