...
// 0x0B08 (FullSize[0x0D70] - InheritedSize[0x0268])
class UFreddy_Charge_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_Z9NS[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_S16G[0x7];                                     // 0x0329(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F5PC[0x4];                                     // 0x03DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2TVY[0x3];                                     // 0x0D55(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Freddy_Charge_ABP.Freddy_Charge_ABP_C");
		return ptr;
	}
