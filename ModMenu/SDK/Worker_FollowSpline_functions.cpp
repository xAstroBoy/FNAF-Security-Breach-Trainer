...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_FollowSpline.Worker_FollowSpline_C.ReceiveTickAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_FollowSpline.Worker_FollowSpline_C.ExecuteUbergraph_Worker_FollowSpline");
