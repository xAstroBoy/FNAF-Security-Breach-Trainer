...
namespace CG
{
	...
	public:
		...
		bool STATIC_PutSecureInt(const class FString& Key, int DataToStore);
		...
		bool STATIC_PutSecureArray(const class FString& Key, TArray<int> DataToStore);
		...
		bool STATIC_GetSecureInt(const class FString& Key, int* DataToRetrieve);
		...
		bool STATIC_GetSecureArray(const class FString& Key, TArray<int>* DataToRetrieve);
