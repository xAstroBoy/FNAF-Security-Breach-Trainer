...
namespace CG
{
	...
	{
	public:
		EFNAFAISpawnType                                           CharacterType_13_F6BE47E348A75053DB03529BB9D53D52;       // 0x0000(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_O51N[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              Materials0_3_BF0994124A6E32451268EFBD8BD9CAE1[0x10];     // 0x0008(0x0010) UNKNOWN PROPERTY: ArrayProperty
