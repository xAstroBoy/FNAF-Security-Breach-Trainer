...
namespace CG
{
	...
	public:
		...
		TEnumAsByte<SplineFollowDirection_ESplineFollowDirection>  Direction;                                               // 0x0028(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
