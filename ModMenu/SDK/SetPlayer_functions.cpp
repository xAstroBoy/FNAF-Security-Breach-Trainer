...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetPlayer.SetPlayer_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetPlayer.SetPlayer_C.ExecuteUbergraph_SetPlayer");
