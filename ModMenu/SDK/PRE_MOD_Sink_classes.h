...
// BlueprintGeneratedClass PRE_MOD_Sink.PRE_MOD_Sink_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PRE_MOD_Sink.PRE_MOD_Sink_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PRE_MOD_Sink(int EntryPoint);
};
