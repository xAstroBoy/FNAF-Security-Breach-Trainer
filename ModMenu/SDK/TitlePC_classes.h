...
// 0x0029 (FullSize[0x05E9] - InheritedSize[0x05C0])
...
public:
	...
	unsigned char                                      UnknownData_20Z1[0x2];                                     // 0x05DE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass TitlePC.TitlePC_C");
		return ptr;
	}
