...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_H27T[0x3];                                   // 0x0261(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnFailure_9627632E42AF1548717DA3A133495CE7(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
		void OnSuccess_9627632E42AF1548717DA3A133495CE7(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
