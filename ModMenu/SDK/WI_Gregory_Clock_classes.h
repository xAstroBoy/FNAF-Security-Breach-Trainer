...
public:
	...
	unsigned char                                      UnknownData_QRH5[0x3];                                     // 0x0261(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                MinuteTracker;                                             // 0x0264(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_Gregory_Clock.WI_Gregory_Clock_C");
		return ptr;
	}
	...
	void OnFailure_9627632E42AF1548717DA3A133495CE7(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_9627632E42AF1548717DA3A133495CE7(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void Tick(const struct FGeometry& MyGeometry, float InDeltaTime);
	void Showtime();
	void ShowTimeNoRunClock();
	void ExecuteUbergraph_WI_Gregory_Clock(int EntryPoint);
};
