...
namespace CG
{
	...
	public:
		...
		class FScriptMulticastDelegate                             RechargeDone;                                            // 0x0268(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
