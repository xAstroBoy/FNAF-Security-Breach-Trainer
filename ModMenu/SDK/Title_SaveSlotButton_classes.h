...
// 0x0301 (FullSize[0x0531] - InheritedSize[0x0230])
...
public:
	...
	struct FScriptMulticastDelegate                    OnHovered;                                                 // 0x0278(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FString                                     SaveSlotName;                                              // 0x0288(0x0010) (Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_N94H[0x6];                                     // 0x02A2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Title_SaveSlotButton.Title_SaveSlotButton_C");
		return ptr;
	}
	...
	void TriggerSave();
	void SetDisplayedData(const struct FString& SaveFileName, int GameHour, const struct FDateTime& DateTimeWhenSaved, int GameplayTime_Sec);
