...
public:
	...
	unsigned char                                      UnknownData_9H11[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JZAC[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<float>                                      PastVelocities;                                            // 0x00E0(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PhysicsSoundImpact.PhysicsSoundImpact_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PhysicsSoundImpact(int EntryPoint);
};
