...
// 0x0F2A (FullSize[0x1192] - InheritedSize[0x0268])
class UAnimatrronic_Aim_ABP_LINK_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_U9DF[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_1I3E[0x8];                                     // 0x0528(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VI76[0x3];                                     // 0x1165(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B5S5[0x3];                                     // 0x1175(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DTH2[0x3];                                     // 0x117D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YQE7[0x2];                                     // 0x1186(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Animatrronic_Aim_ABP_LINK.Animatrronic_Aim_ABP_LINK_C");
		return ptr;
	}
