...
// 0x03C8 (FullSize[0x05F0] - InheritedSize[0x0228])
...
public:
	...
	unsigned char                                      UnknownData_QL01[0x8];                                     // 0x02B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FName                                       MissionToComplete;                                         // 0x02F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FName                                       NextMissionToStart;                                        // 0x02F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      VanessaSpawnLocation[0x28];                                // 0x0300(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
	struct FText                                       ExitFreddyInstruction;                                     // 0x0328(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       LookAroundInstruction;                                     // 0x0340(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       LookAtWindowInstruction;                                   // 0x0358(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       TakeFazwatchInstruction;                                   // 0x0370(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       OpenFazwatchInstruction;                                   // 0x0388(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_BF2P[0x2];                                     // 0x03F2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       MissionToStart;                                            // 0x03F4(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_WDEW[0x3];                                     // 0x03FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8BL7[0x5];                                     // 0x0443(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QGLX[0x4];                                     // 0x04A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TArray<struct FName>                               MissionsWithoutFreddy;                                     // 0x04D8(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	struct FText                                       LookRightInstruction;                                      // 0x04E8(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       LookLeftInstruction;                                       // 0x0500(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       LookDownInstruction;                                       // 0x0518(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       LookUpInstruction;                                         // 0x0530(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_FIE3[0x7];                                     // 0x0599(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass StartupMissionTrigger.StartupMissionTrigger_C");
		return ptr;
	}
	...
	void BndEvt__VanessaRemoveBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	void BndEvt__LookOutWindowTrigger_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	...
	void Vanessa_Spawn();
	void On_Debug_Skipped(TArray<struct FName> SkippedTasks);
	void GregoryScared();
	...
	void ExecuteUbergraph_StartupMissionTrigger(int EntryPoint);
};
