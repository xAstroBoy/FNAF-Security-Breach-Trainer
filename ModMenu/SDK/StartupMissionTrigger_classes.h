...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9YLI[0x8];                                   // 0x02B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YEXG[0x2];                                   // 0x03F2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S04E[0x3];                                   // 0x03FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		TArray<class AFirstPersonCharacter_C*>                     Characters;                                              // 0x0408(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance
		...
		unsigned char                                              UnknownData_Q8RN[0x5];                                   // 0x0443(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              LineSkipper[0x28];                                       // 0x0448(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
		...
		unsigned char                                              UnknownData_T1OJ[0x4];                                   // 0x04A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		TArray<class FName>                                        MissionsWithoutFreddy;                                   // 0x04D8(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		...
		unsigned char                                              UnknownData_RPF3[0x7];                                   // 0x0599(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              PlanarReflection[0x28];                                  // 0x05A0(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
		unsigned char                                              Freddy[0x28];                                            // 0x05C8(0x0028) UNKNOWN PROPERTY: SoftObjectProperty

	public:
		void IsStartupMission(bool* StartupMission);
		...
		void CheckDestroyIntro(bool* Destroyed);
		...
		void OnFazwatchCollected();
		void BackDoorOpen();
		void OnSideDoorEntered(class UDoorComponent* DoorComponent, class APawn* Pawn, bool bPassedDoorCheck, EConditionFailReason FailReason);
		void EnableDoorTrigger();
		void WrongDoor(class AActor* OverlappedActor, class AActor* OtherActor);
		void VanessaSpawn();
		void OnDebugSkipped(TArray<class FName> SkippedTasks);
		void GregoryScared();
		void ReturnRotation();
		...
		void OnFreddyExited();
		void OnPlayerPossessedGregory(class APawn* PossessedPawn);
		void SkipAll();
		void Continuefromsaveafterdoor();
		void BindPossesforFinish();
		void LookOutWindowLogic(class AActor* OtherActor);
		void OnSkip();
