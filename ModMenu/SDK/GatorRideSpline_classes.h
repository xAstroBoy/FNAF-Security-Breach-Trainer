...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MMC9[0x4];                                   // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		int32_t                                                    NumberOfCarts;                                           // 0x0288(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void SetupCarts();
		void ExecuteUbergraph_GatorRideSpline(int32_t EntryPoint);
