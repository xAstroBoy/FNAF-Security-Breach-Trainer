...
// 0x00C3 (FullSize[0x02EB] - InheritedSize[0x0228])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Open__Direction_5CA643F545D86ACD8A04A8BAA0EA07BE;          // 0x026C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_CZ14[0x3];                                     // 0x026D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Press_Nose_Button__Direction_57D98FBC4A6FB4C10C16C3A2B119E9DC; // 0x027C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_TXP6[0x3];                                     // 0x027D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Close__Direction_0065AABA487BDBCD6F160E9CD00DA8FA;         // 0x028C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_PUZZ[0x3];                                     // 0x028D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0RX3[0x6];                                     // 0x029A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnCollectSecurityBadge;                                    // 0x02A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FName                                       ItemAward;                                                 // 0x02B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FName                                       BadgeAward;                                                // 0x02B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_WUPQ[0x6];                                     // 0x02C2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnInteract;                                                // 0x02C8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    OnAnimSequenceFinished;                                    // 0x02D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PRE_BadgeHolder.PRE_BadgeHolder_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PRE_BadgeHolder(int EntryPoint);
