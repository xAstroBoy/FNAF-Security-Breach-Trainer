...
namespace CG
{
	...
	public:
		...
		fnaf9_EFNAFAISpawnType                                     AIType;                                                  // 0x02F0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_WTAI[0x7];                                   // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		TArray<fnaf9_EFNAFAISpawnType>                             StaffBotAlertTypes;                                      // 0x0338(0x0010) Edit, BlueprintVisible, HasGetValueTypeHash
