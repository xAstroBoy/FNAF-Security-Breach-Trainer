...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetChaseMode.SetChaseMode_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetChaseMode.SetChaseMode_C.ExecuteUbergraph_SetChaseMode");
