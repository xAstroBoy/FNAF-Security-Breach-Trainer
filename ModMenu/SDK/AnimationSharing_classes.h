...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_K18Y[0x7];                                   // 0x0279(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_STVU[0x8];                                   // 0x0288(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0ORH[0x3];                                   // 0x027D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_A4FI[0x3];                                   // 0x027D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2IX3[0x70];                                  // 0x0038(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9FM9[0x38];                                  // 0x00B0(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NFTK[0x10];                                  // 0x00F8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4OPY[0x20];                                  // 0x0118(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1POW[0x40];                                  // 0x0048(0x0040) MISSED OFFSET (PADDING)
