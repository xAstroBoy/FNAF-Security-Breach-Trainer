...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_Z8VO[0x7];                                   // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x00A8(0x0008) ZeroConstructor, Transient, DuplicateTransient
		TArray<class AActor*>                                      VisibleInformationProviders;                             // 0x00B0(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance
