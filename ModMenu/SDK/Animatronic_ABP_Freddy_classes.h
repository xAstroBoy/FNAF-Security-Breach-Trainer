...
// 0x0070 (FullSize[0x8E58] - InheritedSize[0x8DE8])
...
public:
	...
	unsigned char                                      UnknownData_IQM7[0x1];                                     // 0x8DF7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RNWK[0x3];                                     // 0x8E31(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Animatronic_ABP_Freddy.Animatronic_ABP_Freddy_C");
		return ptr;
	}
