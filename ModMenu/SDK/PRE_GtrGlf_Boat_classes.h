...
// BlueprintGeneratedClass PRE_GtrGlf_Boat.PRE_GtrGlf_Boat_C
...
public:
	...
	float                                              Subtle_bob_NewTrack_0_A22D76574E126075D55818A2A913D7A1;    // 0x0238(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<Engine_ETimelineDirection>             Subtle_bob__Direction_A22D76574E126075D55818A2A913D7A1;    // 0x023C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_C7G2[0x3];                                     // 0x023D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PRE_GtrGlf_Boat.PRE_GtrGlf_Boat_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PRE_GtrGlf_Boat(int EntryPoint);
};
