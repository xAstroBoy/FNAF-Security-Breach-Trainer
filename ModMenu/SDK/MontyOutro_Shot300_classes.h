...
// BlueprintGeneratedClass MontyOutro_Shot300.SequenceDirector_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass MontyOutro_Shot300.SequenceDirector_C");
		return ptr;
	}



	void SequenceEvent__ENTRYPOINTSequenceDirector_3(class ACinematic_Actor_Monty_C* Cinematic_Actor_Monty);
