...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetDaycareWanderpoint.SetDaycareWanderpoint_C.ReceiveExecuteAI");
...
void USetDaycareWanderpoint_C::ExecuteUbergraph_SetDaycareWanderpoint(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetDaycareWanderpoint.SetDaycareWanderpoint_C.ExecuteUbergraph_SetDaycareWanderpoint");
