...
namespace CG
{
	...
	public:
		...
		int32_t                                                    LaserTagCurrentScore;                                    // 0x02E0(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    CurrentHighScore;                                        // 0x02E4(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_3947[0x7];                                   // 0x0309(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void SubtractPlayerScore(int32_t Score_Change);
		...
		void Start_Demo();
		void ExecuteUbergraph_LaserTag_GM(int32_t EntryPoint);
