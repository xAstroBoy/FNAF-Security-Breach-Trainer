...
public:
	...
	unsigned char                                      UnknownData_1HQS[0x7];                                     // 0x0309(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass LaserTag_GM.LaserTag_GM_C");
		return ptr;
	}
