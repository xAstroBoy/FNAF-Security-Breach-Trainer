...
namespace CG
{
	...
	public:
		...
		class FScriptMulticastDelegate                             ItemSelected;                                            // 0x0248(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		unsigned char                                              UnknownData_YCNT[0x3];                                   // 0x0279(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
