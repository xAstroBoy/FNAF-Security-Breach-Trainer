...
// 0x0071 (FullSize[0x02B1] - InheritedSize[0x0240])
...
public:
	...
	struct FScriptMulticastDelegate                    PowerLevelDispatch;                                        // 0x0280(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_Gregory_Flashlight.WI_Gregory_Flashlight_C");
		return ptr;
	}
