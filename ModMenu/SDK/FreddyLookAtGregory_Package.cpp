...
namespace CG
{
	...
	void UFreddyLookAtGregory_C::ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FreddyLookAtGregory.FreddyLookAtGregory_C.ReceiveExecuteAI");
	...
	void UFreddyLookAtGregory_C::ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FreddyLookAtGregory.FreddyLookAtGregory_C.ReceiveAbortAI");
	...
	void UFreddyLookAtGregory_C::ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FreddyLookAtGregory.FreddyLookAtGregory_C.ReceiveTickAI");
	...
	void UFreddyLookAtGregory_C::ExecuteUbergraph_FreddyLookAtGregory(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FreddyLookAtGregory.FreddyLookAtGregory_C.ExecuteUbergraph_FreddyLookAtGregory");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UFreddyLookAtGregory_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UFreddyLookAtGregory_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass FreddyLookAtGregory.FreddyLookAtGregory_C");
		return ptr;
	}
