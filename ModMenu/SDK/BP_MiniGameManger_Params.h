...
namespace CG
{
	...
	{
	public:
		E_EndMiniGameType_E_EndMiniGameType                        End_Type;                                                // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
