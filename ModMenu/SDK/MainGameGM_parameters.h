...
{
	TArray<struct FName>                               SkippedTasks;                                              // 0x0028(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
};
...
struct AMainGameGM_C_On_Freddy_Teleport_Query_Finished_Params
{
	...
	TEnumAsByte<AIModule_EEnvQueryStatus>              QueryStatus;                                               // 0x0008(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
