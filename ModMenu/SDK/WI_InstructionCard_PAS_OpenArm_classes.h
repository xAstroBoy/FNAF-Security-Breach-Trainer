...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_OpenArm.WI_InstructionCard_PAS_OpenArm_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_OpenArm(int EntryPoint);
};
