...
public:
	...
	unsigned char                                      UnknownData_3MBI[0x3];                                     // 0x0215(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BSX1[0x4];                                     // 0x021C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K3QX[0x20];                                    // 0x0240(0x0020) MISSED OFFSET (PADDING)
