...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_FinishProcedure_Ocular.WI_InstructionCard_PAS_FinishProcedure_Ocular_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_FinishProcedure_Ocular(int EntryPoint);
};
