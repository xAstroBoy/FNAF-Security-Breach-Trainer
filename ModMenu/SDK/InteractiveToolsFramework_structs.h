...
{
	unsigned char                                      UnknownData_9GCC[0xA8];                                    // 0x0000(0x00A8) MISSED OFFSET (PADDING)
...
struct FBehaviorInfo
{
	...
	unsigned char                                      UnknownData_A9IX[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FActiveGizmo
{
	unsigned char                                      UnknownData_89JX[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FInputRayHit
{
	unsigned char                                      UnknownData_60LE[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
