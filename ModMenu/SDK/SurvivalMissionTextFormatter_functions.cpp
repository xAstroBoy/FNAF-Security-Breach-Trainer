...
void USurvivalMissionTextFormatter_C::GetFormattedText(const struct FText& TaskTitleText, const struct FFNAFMissionState& MissionState, int StateIndex, struct FText* FormattedTaskTitleText)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SurvivalMissionTextFormatter.SurvivalMissionTextFormatter_C.GetFormattedText");
