...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.LaserHit");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.ForceKill");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.GameStart");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.GameEnd");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.GameExit");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.PlayerHit");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.Construct");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.DestroyThisShowFinalScore");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.DisplayGameOver");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_GameOver.WI_GameOver_C.ExecuteUbergraph_WI_GameOver");
