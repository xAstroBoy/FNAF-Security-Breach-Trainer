...
// BlueprintGeneratedClass SM_Scafoldings_Stairs_Half.SM_Scafoldings_Stairs_Half_C
// 0x0028 (FullSize[0x0250] - InheritedSize[0x0228])
class ASM_Scafoldings_Stairs_Half_C : public AActor
{
public:
	class UBoxComponent*                               Box3;                                                      // 0x0228(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass SM_Scafoldings_Stairs_Half.SM_Scafoldings_Stairs_Half_C");
		return ptr;
	}
