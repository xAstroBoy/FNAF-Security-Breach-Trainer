...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_HBTY[0x2];                                   // 0x046E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CNXV[0x20];                                  // 0x0490(0x0020) MISSED OFFSET (PADDING)
