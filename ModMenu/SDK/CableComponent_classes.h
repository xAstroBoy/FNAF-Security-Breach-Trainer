...
{
public:
	unsigned char                                      UnknownData_GRFY[0x8];                                     // 0x0418(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_1IEN[0x2];                                     // 0x046E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DK7S[0x20];                                    // 0x0490(0x0020) MISSED OFFSET (PADDING)
