...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_TakeOutEyes.WI_InstructionCard_PAS_TakeOutEyes_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_TakeOutEyes(int EntryPoint);
};
