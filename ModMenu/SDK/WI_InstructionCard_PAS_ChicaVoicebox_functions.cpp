...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_InstructionCard_PAS_ChicaVoicebox.WI_InstructionCard_PAS_ChicaVoicebox_C.Tick");
...
void UWI_InstructionCard_PAS_ChicaVoicebox_C::ExecuteUbergraph_WI_InstructionCard_PAS_ChicaVoicebox(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_InstructionCard_PAS_ChicaVoicebox.WI_InstructionCard_PAS_ChicaVoicebox_C.ExecuteUbergraph_WI_InstructionCard_PAS_ChicaVoicebox");
