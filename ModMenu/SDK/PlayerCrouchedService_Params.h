...
namespace CG
{
	 ...
	 */
	struct UPlayerCrouchedService_C_UpdateCrouched_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_X6WZ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
