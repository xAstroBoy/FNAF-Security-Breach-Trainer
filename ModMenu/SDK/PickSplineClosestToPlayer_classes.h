...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_85V9[0x4];                                   // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_PickSplineClosestToPlayer(int32_t EntryPoint);
