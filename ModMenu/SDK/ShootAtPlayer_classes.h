...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MEZW[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void GameEnd();
		void GameStart();
		void ExecuteUbergraph_ShootAtPlayer(int32_t EntryPoint);
