...
public:
	...
	unsigned char                                      UnknownData_NW8T[0x3];                                     // 0x0345(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0WE5[0x3];                                     // 0x0355(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       GregoryKey;                                                // 0x0358(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FName                                       StateKey;                                                  // 0x0368(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_I1YI[0x2];                                     // 0x037A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0DUK[0x4];                                     // 0x0384(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TQZJ[0x4];                                     // 0x039C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FName                                       MoveToLocationKey;                                         // 0x03A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass FreddyAIController.FreddyAIController_C");
		return ptr;
	}
	...
	void OnNotifyEnd_30B75CD34307316BF7A1EF9DC900582F(const struct FName& NotifyName);
	void OnNotifyBegin_30B75CD34307316BF7A1EF9DC900582F(const struct FName& NotifyName);
	void OnInterrupted_30B75CD34307316BF7A1EF9DC900582F(const struct FName& NotifyName);
	void OnBlendOut_30B75CD34307316BF7A1EF9DC900582F(const struct FName& NotifyName);
	void OnCompleted_30B75CD34307316BF7A1EF9DC900582F(const struct FName& NotifyName);
