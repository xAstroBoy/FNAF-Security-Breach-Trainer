...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_FinishProcedure.WI_InstructionCard_PAS_FinishProcedure_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_FinishProcedure(int EntryPoint);
};
