...
#include "../pch.h"
#include "MissionTextFormatter_Package.h"
...
namespace CG
{
	 ...
	 */
	void UMissionTextFormatter_C::GetFormattedText(const class FText& TaskTitleText, const struct FFNAFMissionState& MissionState, int StateIndex, class FText* FormattedTaskTitleText)
	{
