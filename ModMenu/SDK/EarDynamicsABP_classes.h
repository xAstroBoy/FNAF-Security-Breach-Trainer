...
namespace CG
{
	 ...
	 * Size -> 0x1564 (FullSize[0x17D4] - InheritedSize[0x0270])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_TF49[0x8];                                   // 0x02A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M89J[0x3];                                   // 0x17C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
