...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_2VWG[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              Doorstoshock[0x10];                                      // 0x02A8(0x0010) UNKNOWN PROPERTY: ArrayProperty
