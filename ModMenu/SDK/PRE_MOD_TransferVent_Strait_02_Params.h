...
namespace CG
{
	 ...
	 */
	struct APRE_MOD_TransferVent_Strait_02_C_ToggleInRange_Params
	{
	public:
	 ...
	 */
	struct APRE_MOD_TransferVent_Strait_02_C_ExecuteUbergraph_PRE_MOD_TransferVent_Strait_02_Params
	{
	public:
