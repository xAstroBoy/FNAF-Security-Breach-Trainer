...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_A72I[0x3];                                   // 0x0249(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JOSM[0x4];                                   // 0x0254(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<struct FDoorPointsProgress>                         DoorPoints;                                              // 0x0258(0x0010) Edit, BlueprintVisible
		...
		unsigned char                                              UnknownData_ETYO[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MYXR[0x3];                                   // 0x029D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EG2C[0x4];                                   // 0x02CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UAkAudioEvent*>                               RoxyLines;                                               // 0x02D0(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		TArray<class UAkAudioEvent*>                               MontyLines;                                              // 0x02E0(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
	...
	public:
		...
		void SetDoorsLocked(bool Locked, bool Close, bool Applytoplayer);
		...
		void ShockDoors(TArray<class AActor*> ActorsToStun);
		void OnCharacterMovedIn();
		void ReceiveTick(float DeltaSeconds);
		void OuterDoorsUnlocked();
