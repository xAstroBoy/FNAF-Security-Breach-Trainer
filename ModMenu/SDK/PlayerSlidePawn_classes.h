...
namespace CG
{
	...
	public:
		...
		class FScriptMulticastDelegate                             OnFinishedFollowingSpline;                               // 0x02D0(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
