...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass ChicaBehindPlayerBreathing_Task.ChicaBehindPlayerBreathing_Task_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_ChicaBehindPlayerBreathing_Task(int EntryPoint);
};
