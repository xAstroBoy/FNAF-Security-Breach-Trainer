...
public:
	...
	unsigned char                                      UnknownData_B9K0[0x7];                                     // 0x0291(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    NoMoreLogos;                                               // 0x02A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FString                                     PlayerSettingsData;                                        // 0x02B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_SplashScreen.WI_SplashScreen_C");
		return ptr;
	}
	...
	void Load_Level();
	void ExecuteUbergraph_WI_SplashScreen(int EntryPoint);
