...
// 0x00E8 (FullSize[0x0370] - InheritedSize[0x0288])
...
public:
	...
	unsigned char                                      UnknownData_ZH7V[0x4];                                     // 0x033C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass P_GoKart.P_GoKart_C");
		return ptr;
	}
	...
	void GameEnd();
	void ExecuteUbergraph_P_GoKart(int EntryPoint);
};
