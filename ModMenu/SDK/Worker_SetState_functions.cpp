...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_SetState.Worker_SetState_C.ReceiveExecuteAI");
...
void UWorker_SetState_C::ExecuteUbergraph_Worker_SetState(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_SetState.Worker_SetState_C.ExecuteUbergraph_Worker_SetState");
