...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Flash__Direction_3E6B0B244509C68F95AC899478D47DF9;         // 0x023C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_TX5I[0x3];                                     // 0x023D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TArray<class USkeletalMeshComponent*>              ArayOfDiscoLights;                                         // 0x02D8(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_SoundBoothManager.BP_SoundBoothManager_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_SoundBoothManager(int EntryPoint);
};
