...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_OrientToNewDirection.Worker_OrientToNewDirection_C.ReceiveTickAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_OrientToNewDirection.Worker_OrientToNewDirection_C.ExecuteUbergraph_Worker_OrientToNewDirection");
