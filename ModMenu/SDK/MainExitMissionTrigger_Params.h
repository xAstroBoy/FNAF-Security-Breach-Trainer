...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function MainExitMissionTrigger.MainExitMissionTrigger_C.CanTrigger
	 */
	struct AMainExitMissionTrigger_C_CanTrigger_Params
	{
	public:
	 ...
	 */
	struct AMainExitMissionTrigger_C_ExecuteUbergraph_MainExitMissionTrigger_Params
	{
	public:
