...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function ChasePlayer.ChasePlayer_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function ChasePlayer.ChasePlayer_C.ExecuteUbergraph_ChasePlayer");
