...
// 0x0654 (FullSize[0x08BC] - InheritedSize[0x0268])
class URIG_Hook_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_DUNK[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_GNIZ[0x3];                                     // 0x08A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass RIG_Hook_ABP.RIG_Hook_ABP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_RIG_Hook_ABP(int EntryPoint);
};
