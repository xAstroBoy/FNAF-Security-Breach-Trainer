...
public:
	...
	unsigned char                                      UnknownData_PPAD[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FFNAFMessageTableStruct                     Data;                                                      // 0x0290(0x0068) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FName                                       Name;                                                      // 0x02F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_DU8R[0x3];                                     // 0x0309(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_Message.WI_Message_C");
		return ptr;
	}
	...
	void Update(const struct FName& Name, const struct FFNAFMessageTableStruct& FNAFMessageTableStruct);
