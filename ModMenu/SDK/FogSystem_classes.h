...
public:
	...
	struct FName                                       CurrentScenario;                                           // 0x0288(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass FogSystem.FogSystem_C");
		return ptr;
	}
	...
	void Set_Fog_Scenario(const struct FName& FogScenario);
