...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_0__Direction_A1496DB149BC8BBC56B98E96F25145CC;    // 0x0260(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_6VTY[0x7];                                     // 0x0261(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OADA[0x4];                                     // 0x027C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass VannyDistortionActor.VannyDistortionActor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_VannyDistortionActor(int EntryPoint);
};
