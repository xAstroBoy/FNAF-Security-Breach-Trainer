...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass WestArcadeHolesManagerOG.WestArcadeHolesManagerOG_C
	 * Size -> 0x0028 (FullSize[0x0250] - InheritedSize[0x0228])
	 */
	class AWestArcadeHolesManagerOG_C : public AActor
	{
	public:
	...
	public:
		...
		void Update();
		void ExecuteUbergraph_WestArcadeHolesManagerOG(int32_t EntryPoint);
