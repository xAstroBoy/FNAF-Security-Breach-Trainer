...
// BlueprintGeneratedClass PlayerPlacementLocator.PlayerPlacementLocator_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PlayerPlacementLocator.PlayerPlacementLocator_C");
		return ptr;
	}
