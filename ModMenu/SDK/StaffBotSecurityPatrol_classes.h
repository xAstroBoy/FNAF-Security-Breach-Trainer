...
// 0x006A (FullSize[0x06BC] - InheritedSize[0x0652])
class AStaffBotSecurityPatrol_C : public AStaffBotBase_C
{
public:
	unsigned char                                      UnknownData_QCKY[0x6];                                     // 0x0652(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FName                                       SplineManagerKey;                                          // 0x06A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FName                                       SplineMovementSpeedKey;                                    // 0x06B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass StaffBotSecurityPatrol.StaffBotSecurityPatrol_C");
		return ptr;
	}
