...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_FinishProcedure_Claws.WI_InstructionCard_PAS_FinishProcedure_Claws_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_FinishProcedure_Claws(int EntryPoint);
};
