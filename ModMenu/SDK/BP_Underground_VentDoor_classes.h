...
public:
	...
	unsigned char                                      UnknownData_OI2Q[0x3];                                     // 0x026D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Underground_VentDoor.BP_Underground_VentDoor_C");
		return ptr;
	}
