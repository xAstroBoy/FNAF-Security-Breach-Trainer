...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_SVGY[0x3];                                   // 0x0055(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TZH5[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
