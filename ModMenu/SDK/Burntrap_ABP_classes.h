...
// 0x11CB (FullSize[0x1433] - InheritedSize[0x0268])
class UBurntrap_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_9CQ6[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_IFVV[0x8];                                     // 0x0B88(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D8RX[0x6];                                     // 0x1412(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Burntrap_ABP.Burntrap_ABP_C");
		return ptr;
	}
