...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UC8W[0x8];                                   // 0x0B88(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WSCM[0x6];                                   // 0x1412(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
