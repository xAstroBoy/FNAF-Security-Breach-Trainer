...
// 0x029C (FullSize[0x0518] - InheritedSize[0x027C])
class AMGM_FazerBlast_C : public ABP_MiniGameManger_C
{
public:
	unsigned char                                      UnknownData_0IB7[0x4];                                     // 0x027C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZDIK[0x4];                                     // 0x02B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                P_Score;                                                   // 0x02C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_HH63[0x3];                                     // 0x02C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                EnemyLimit;                                                // 0x02D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int                                                P_EnemyCount;                                              // 0x0360(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FName                                       P_MissionName;                                             // 0x0364(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Y8TE[0x4];                                     // 0x036C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I0V0[0x6];                                     // 0x03D2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                CapturedFlags;                                             // 0x0490(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_UFQ4[0x4];                                     // 0x0494(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass MGM_FazerBlast.MGM_FazerBlast_C");
		return ptr;
	}
	...
	void On_Start();
	void UpdateMissionTask(bool I_Leaving, int I_TaskIndex);
	void TrySpawn();
	...
	void OnFailure_EE39226D48E410FC896D9D8565A580FF(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_EE39226D48E410FC896D9D8565A580FF(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	...
	void PlayAreaInit();
	void DoorLock(bool Locked, bool Closed, int Lost_Doors);
	void SpawnEnemies();
	void ResetGame();
	...
	void ExecuteUbergraph_MGM_FazerBlast(int EntryPoint);
};
