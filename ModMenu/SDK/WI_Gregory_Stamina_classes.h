...
// 0x0059 (FullSize[0x0299] - InheritedSize[0x0240])
...
public:
	...
	struct FScriptMulticastDelegate                    PowerLevelDispatch;                                        // 0x0270(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_Gregory_Stamina.WI_Gregory_Stamina_C");
		return ptr;
	}
