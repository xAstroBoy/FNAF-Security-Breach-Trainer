...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_U0EQ[0x7];                                   // 0x0111(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LQVK[0x6];                                   // 0x0152(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7GLK[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6H3Y[0x2];                                   // 0x0046(0x0002) MISSED OFFSET (PADDING)
