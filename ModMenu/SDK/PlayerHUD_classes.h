...
public:
	...
	unsigned char                                      UnknownData_HT4P[0x3];                                     // 0x0329(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       InteractionsTableID;                                       // 0x032C(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_MJZW[0x4];                                     // 0x0334(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JOH6[0x7];                                     // 0x0359(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TMap<struct FString, class UTexture2D*>            CollectedItemsQue;                                         // 0x0370(0x0050) (Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<struct FText>                               CollectedItemNameList;                                     // 0x03C0(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	...
	TMap<struct FString, struct FString>               KeyIconMappings;                                           // 0x03F0(0x0050) (Edit, BlueprintVisible, DisableEditOnInstance)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass PlayerHUD.PlayerHUD_C");
		return ptr;
	}
	...
	void CheckPlayerPawnRestrictions(TArray<fnaf9_EPlayerPawnType> TargetArray, struct FText* Result);
	void ResetProgressWheel();
	float Get_Stamina_Percent();
	void GetItemOrMessageName(const struct FName& InputPin, struct FText* ItemDisplayName, class UTexture2D** Item_Display_Icon);
	...
	void OnFailure_AB03661843CC503A6CB2D5BF99086A7C(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_AB03661843CC503A6CB2D5BF99086A7C(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_7DBB82C44AE86FE3123C8CA2C34C6B7D();
	void OnSuccess_7DBB82C44AE86FE3123C8CA2C34C6B7D();
	void OnFailure_B754F15B4449FCC342E9AAB708667094(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_B754F15B4449FCC342E9AAB708667094(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	...
	void Set_Informational_Message(const struct FText& InText);
	...
	void Setup_Objective_Display(const struct FText& InText);
	...
	void Setup_Collected_Display(const struct FName& CollectedItem);
	void MoveMissionHUD();
