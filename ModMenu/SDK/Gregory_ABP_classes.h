...
// 0x18C8 (FullSize[0x1B30] - InheritedSize[0x0268])
class UGregory_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_RIXM[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_FB40[0x3];                                     // 0x1A65(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R8GT[0x3];                                     // 0x1A6D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VO58[0x2];                                     // 0x1A7A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1IVK[0x3];                                     // 0x1A8D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ABST[0x3];                                     // 0x1AA9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P1DR[0x3];                                     // 0x1AB9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6DWS[0x3];                                     // 0x1AC5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QAHC[0x3];                                     // 0x1AF1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FPGN[0x3];                                     // 0x1AF9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HRIK[0x5];                                     // 0x1B13(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8B2S[0x7];                                     // 0x1B21(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Gregory_ABP.Gregory_ABP_C");
		return ptr;
	}
