...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_ReplaceChestPlate.WI_InstructionCard_PAS_ReplaceChestPlate_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_ReplaceChestPlate(int EntryPoint);
};
