...
public:
	...
	unsigned char                                      UnknownData_CD55[0x3];                                     // 0x0299(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WMNC[0x7];                                     // 0x02D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HM2R[0x3];                                     // 0x02E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                GolfCamIndex;                                              // 0x02EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               changecamera;                                              // 0x02F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_UZGF[0x7];                                     // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SecurityCameraUI.SecurityCameraUI_C");
		return ptr;
	}



	void Get_Direction(const struct FVector2D& Dir, int* Direction);
	void Get_Camera_Comparison_Value(class UWidget* CameraIcon, int Dir, float* Value);
	void SortRow(TArray<class UCameraIcon_C*>* RowToSort);
	void FindCurrentCameraRow(int* Index, TArray<class UCameraIcon_C*>* CameraRow, int* WhichRow);
	...
	void ExecuteUbergraph_SecurityCameraUI(int EntryPoint);
};
