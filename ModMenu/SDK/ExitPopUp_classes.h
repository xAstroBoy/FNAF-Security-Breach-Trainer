...
public:
	...
	struct FScriptMulticastDelegate                    Exit_BackedOut;                                            // 0x0268(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ExitPopUp.ExitPopUp_C");
		return ptr;
	}
