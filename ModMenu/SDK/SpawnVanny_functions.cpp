...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SpawnVanny.SpawnVanny_C.ReceiveExecuteAI");
...
void USpawnVanny_C::ExecuteUbergraph_SpawnVanny(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SpawnVanny.SpawnVanny_C.ExecuteUbergraph_SpawnVanny");
