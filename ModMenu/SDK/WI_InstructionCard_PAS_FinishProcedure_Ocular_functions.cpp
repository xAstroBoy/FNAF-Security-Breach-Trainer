...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_InstructionCard_PAS_FinishProcedure_Ocular.WI_InstructionCard_PAS_FinishProcedure_Ocular_C.Tick");
...
void UWI_InstructionCard_PAS_FinishProcedure_Ocular_C::ExecuteUbergraph_WI_InstructionCard_PAS_FinishProcedure_Ocular(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_InstructionCard_PAS_FinishProcedure_Ocular.WI_InstructionCard_PAS_FinishProcedure_Ocular_C.ExecuteUbergraph_WI_InstructionCard_PAS_FinishProcedure_Ocular");
