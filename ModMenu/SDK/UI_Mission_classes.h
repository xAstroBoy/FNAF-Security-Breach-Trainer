...
public:
	...
	unsigned char                                      UnknownData_JT2K[0x7];                                     // 0x0251(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FFNAFMissionInfo                            Data;                                                      // 0x0258(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FName                                       Name;                                                      // 0x02A0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Mission.UI_Mission_C");
		return ptr;
	}
	...
	void Update(const struct FName& Name, const struct FFNAFMissionInfo& Mission, int CurrentIndex);
	void InuputNext();
	void InputPrevious();
	void InputClose();
	void InputBack();
