...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function DestroyActor.DestroyActor_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function DestroyActor.DestroyActor_C.ExecuteUbergraph_DestroyActor");
