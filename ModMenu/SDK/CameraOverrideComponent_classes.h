...
// 0x0053 (FullSize[0x0243] - InheritedSize[0x01F0])
...
public:
	...
	unsigned char                                      UnknownData_3GNN[0x3];                                     // 0x022D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass CameraOverrideComponent.CameraOverrideComponent_C");
		return ptr;
	}
