...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_SetOldState.Worker_SetOldState_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_SetOldState.Worker_SetOldState_C.ExecuteUbergraph_Worker_SetOldState");
