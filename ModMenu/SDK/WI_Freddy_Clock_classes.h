...
public:
	...
	struct FText                                       Am_Pm;                                                     // 0x0268(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                               PM;                                                        // 0x0280(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_PDZN[0x3];                                     // 0x0281(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_Freddy_Clock.WI_Freddy_Clock_C");
		return ptr;
	}
	...
	void OnFailure_FBD07C26434C6628805089838B398A42(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_FBD07C26434C6628805089838B398A42(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
