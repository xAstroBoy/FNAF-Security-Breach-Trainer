...
public:
	...
	unsigned char                                      UnknownData_DPES[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5VQL[0x3];                                     // 0x0159(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass MontyJump.MontyJump_C");
		return ptr;
	}
	...
	void OnNotifyEnd_95A8414241D4C3D70915AFB59A5B125F(const struct FName& NotifyName);
	void OnNotifyBegin_95A8414241D4C3D70915AFB59A5B125F(const struct FName& NotifyName);
	void OnInterrupted_95A8414241D4C3D70915AFB59A5B125F(const struct FName& NotifyName);
	void OnBlendOut_95A8414241D4C3D70915AFB59A5B125F(const struct FName& NotifyName);
	void OnCompleted_95A8414241D4C3D70915AFB59A5B125F(const struct FName& NotifyName);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_MontyJump(int EntryPoint);
};
