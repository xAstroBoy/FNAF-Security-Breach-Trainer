...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_ReplaceBowtie.WI_InstructionCard_PAS_ReplaceBowtie_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_ReplaceBowtie(int EntryPoint);
};
