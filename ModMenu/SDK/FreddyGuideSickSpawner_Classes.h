...
namespace CG
{
	...
	public:
		...
		class UMissionStateCondition*                              MissionStateCondition_FreddyAudio;                       // 0x0230(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              PatrolPath[0x28];                                        // 0x0258(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
		int32_t                                                    PatrolPathPointIndex;                                    // 0x0280(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
