...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass FreddyGuideSickSpawner.FreddyGuideSickSpawner_C
	 * Size -> 0x0054 (FullSize[0x027C] - InheritedSize[0x0228])
	 */
	class AFreddyGuideSickSpawner_C : public AActor
	{
	public:
		...
		unsigned char                                              PatrolPath[0x28];                                        // 0x0250(0x0028) UNKNOWN PROPERTY: SoftObjectProperty
		int32_t                                                    PatrolPathPointIndex;                                    // 0x0278(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_FreddyGuideSickSpawner(int32_t EntryPoint);
