...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function ChicaDynamicsAbp.ChicaDynamicsABP_C.AnimGraph
	 */
	struct UChicaDynamicsABP_C_AnimGraph_Params
	{
	public:
	 ...
	 */
	struct UChicaDynamicsABP_C_ExecuteUbergraph_ChicaDynamicsABP_Params
	{
	public:
