...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetSeekMode.SetSeekMode_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetSeekMode.SetSeekMode_C.ExecuteUbergraph_SetSeekMode");
