...
// BlueprintGeneratedClass PRE_SM_Sinks_NEW.PRE_SM_Sinks_NEW_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PRE_SM_Sinks_NEW.PRE_SM_Sinks_NEW_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PRE_SM_Sinks_NEW(int EntryPoint);
};
