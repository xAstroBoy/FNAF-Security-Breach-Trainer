...
// 0x0109 (FullSize[0x0339] - InheritedSize[0x0230])
...
public:
	...
	struct FString                                     SettingsSlotName;                                          // 0x0308(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_0KJS[0x7];                                     // 0x0329(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Options_ControlsUI.Options_ControlsUI_C");
		return ptr;
	}
	...
	void GetAllKeys();
	void Set_References(class USaveGameSettings_C* SaveGameObjext, const struct FString& SettingsName);
