...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function StaffbotTaskPlacement.StaffbotTaskPlacement_C.UserConstructionScript");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function StaffbotTaskPlacement.StaffbotTaskPlacement_C.ReceiveTick");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function StaffbotTaskPlacement.StaffbotTaskPlacement_C.BndEvt__OverlapBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function StaffbotTaskPlacement.StaffbotTaskPlacement_C.ResetPropEvent");
...
//		class UPrimitiveComponent*                         OtherComp                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
//		int                                                OtherBodyIndex                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void AStaffbotTaskPlacement_C::BndEvt__OverlapBox_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function StaffbotTaskPlacement.StaffbotTaskPlacement_C.BndEvt__OverlapBox_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function StaffbotTaskPlacement.StaffbotTaskPlacement_C.Set Has Prop Event");
...
void AStaffbotTaskPlacement_C::ExecuteUbergraph_StaffbotTaskPlacement(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function StaffbotTaskPlacement.StaffbotTaskPlacement_C.ExecuteUbergraph_StaffbotTaskPlacement");
