...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0ZTL[0x17];                                  // 0x0029(0x0017) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1WT2[0x10];                                  // 0x0040(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OAZR[0x10];                                  // 0x0030(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_62US[0x1];                                   // 0x0160(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QJTZ[0x6];                                   // 0x0162(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_T47V[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BPE1[0x10];                                  // 0x0048(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LEWL[0x28];                                  // 0x0160(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_NIIC[0x10];                                  // 0x00C0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5AEF[0x6];                                   // 0x00C2(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PB0Y[0x58];                                  // 0x0028(0x0058) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HJ9V[0xA0];                                  // 0x0028(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_V2L0[0x3];                                   // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JDXT[0x6];                                   // 0x00CA(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TNRA[0x3];                                   // 0x0049(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_UPI5[0x3];                                   // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_E2O7[0x64];                                  // 0x005C(0x0064) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1AXF[0x48];                                  // 0x0038(0x0048) MISSED OFFSET (PADDING)
