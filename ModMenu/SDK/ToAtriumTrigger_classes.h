...
// BlueprintGeneratedClass ToAtriumTrigger.ToAtriumTrigger_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass ToAtriumTrigger.ToAtriumTrigger_C");
		return ptr;
	}
	...
	void OnTriggered();
	void ExecuteUbergraph_ToAtriumTrigger(int EntryPoint);
};
