...
// 0x0378 (FullSize[0x05E0] - InheritedSize[0x0268])
class UCable_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_ST0X[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_OQ67[0x7];                                     // 0x05C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Cable_ABP.Cable_ABP_C");
		return ptr;
	}
