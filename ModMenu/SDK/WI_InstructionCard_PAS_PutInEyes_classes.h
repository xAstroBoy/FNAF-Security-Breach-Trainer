...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_PutInEyes.WI_InstructionCard_PAS_PutInEyes_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_PutInEyes(int EntryPoint);
};
