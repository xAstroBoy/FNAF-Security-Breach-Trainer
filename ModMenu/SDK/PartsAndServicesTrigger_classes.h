...
// BlueprintGeneratedClass PartsAndServicesTrigger.PartsAndServicesTrigger_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PartsAndServicesTrigger.PartsAndServicesTrigger_C");
		return ptr;
	}
	...
	void OnTriggered();
	void ExecuteUbergraph_PartsAndServicesTrigger(int EntryPoint);
};
