...
// 0x0034 (FullSize[0x0825] - InheritedSize[0x07F1])
class AVanny_C : public AAISeeker_C
{
public:
	unsigned char                                      UnknownData_2138[0x7];                                     // 0x07F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TVV6[0x4];                                     // 0x080C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Vanny.Vanny_C");
		return ptr;
	}
