...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Animatronic_ABP_Chica.Animatronic_ABP_Chica_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Animatronic_ABP_Chica(int EntryPoint);
};
