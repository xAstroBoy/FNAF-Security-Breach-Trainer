...
// 0x0048 (FullSize[0x0238] - InheritedSize[0x01F0])
...
public:
	...
	unsigned char                                      UnknownData_GFNP[0x3];                                     // 0x0215(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HIZM[0x4];                                     // 0x022C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass SC_HoverComponent.SC_HoverComponent_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_SC_HoverComponent(int EntryPoint);
};
