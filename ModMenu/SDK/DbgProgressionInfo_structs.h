...
namespace CG
{
	...
	{
	public:
		TArray<class FName>                                        Missions_3_A2EE865442E07898129354B64257DB5B;             // 0x0000(0x0010) Edit, BlueprintVisible
		TArray<class FName>                                        Items_5_0313D851473CC18AE417308CD7795CFB;                // 0x0010(0x0010) Edit, BlueprintVisible
