...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function RIG_Hook_ABP.RIG_Hook_ABP_C.AnimGraph");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function RIG_Hook_ABP.RIG_Hook_ABP_C.BlueprintUpdateAnimation");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function RIG_Hook_ABP.RIG_Hook_ABP_C.BlueprintBeginPlay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function RIG_Hook_ABP.RIG_Hook_ABP_C.ExecuteUbergraph_RIG_Hook_ABP");
