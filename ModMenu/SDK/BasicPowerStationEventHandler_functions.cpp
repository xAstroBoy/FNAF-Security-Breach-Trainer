...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BasicPowerStationEventHandler.BasicPowerStationEventHandler_C.StartPowerStationEvent");
...
void ABasicPowerStationEventHandler_C::ExecuteUbergraph_BasicPowerStationEventHandler(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BasicPowerStationEventHandler.BasicPowerStationEventHandler_C.ExecuteUbergraph_BasicPowerStationEventHandler");
