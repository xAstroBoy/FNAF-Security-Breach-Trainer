...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function ResetWeight.ResetWeight_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function ResetWeight.ResetWeight_C.ExecuteUbergraph_ResetWeight");
