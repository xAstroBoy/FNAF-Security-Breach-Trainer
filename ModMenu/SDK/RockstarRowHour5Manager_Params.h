...
namespace CG
{
	 ...
	 */
	struct ARockstarRowHour5Manager_C_On_Roxy_Left_Params
	{
	public:
	 ...
	 */
	struct ARockstarRowHour5Manager_C_On_Package_Collected_Params
	{
	};

	/**
	 * Function RockstarRowHour5Manager.RockstarRowHour5Manager_C.BndEvt__ExitChicaRoomTrigger_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature
	 */
	struct ARockstarRowHour5Manager_C_BndEvt__ExitChicaRoomTrigger_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature_Params
	{
	public:
		class UPrimitiveComponent*                                 OverlappedComponent;                                     // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		class AActor*                                              OtherActor;                                              // 0x0008(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
