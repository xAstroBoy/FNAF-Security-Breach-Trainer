...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9SNP[0x4];                                   // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_36H1[0x4];                                   // 0x01EC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KGZT[0x20];                                  // 0x0168(0x0020) MISSED OFFSET (PADDING)
