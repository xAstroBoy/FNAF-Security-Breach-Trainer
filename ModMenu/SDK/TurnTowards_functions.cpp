...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function TurnTowards.TurnTowards_C.ReceiveTickAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function TurnTowards.TurnTowards_C.ExecuteUbergraph_TurnTowards");
