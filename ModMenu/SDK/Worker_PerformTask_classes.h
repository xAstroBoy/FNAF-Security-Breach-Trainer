...
// 0x0099 (FullSize[0x0141] - InheritedSize[0x00A8])
...
public:
	...
	unsigned char                                      UnknownData_R6XU[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GTRM[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Worker_PerformTask.Worker_PerformTask_C");
		return ptr;
	}
