...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_C2OZ[0x7];                                   // 0x00B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3I9G[0x7];                                   // 0x0111(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FBlackboardKeySelector                              State;                                                   // 0x0118(0x0028) Edit, BlueprintVisible
		StaffBotWorkerState_EStaffBotWorkerState                   StaffBotWorkerState;                                     // 0x0140(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
