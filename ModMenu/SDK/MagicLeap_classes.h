...
public:
	...
	unsigned char                                      UnknownData_2RF2[0x8];                                     // 0x0120(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2E57[0x50];                                    // 0x0180(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HF1V[0x8];                                     // 0x01F0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HBUL[0x6];                                     // 0x020A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HRWZ[0x3];                                     // 0x0219(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_91ZW[0x3];                                     // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LHP1[0x5];                                     // 0x022B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7CFG[0x7];                                     // 0x0261(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CJMA[0xC];                                     // 0x0274(0x000C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FNHT[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_A4QF[0x68];                                    // 0x00B0(0x0068) MISSED OFFSET (PADDING)
