...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass PRE_MOD_TransferVent_Strait_02.PRE_MOD_TransferVent_Strait_02_C
	 * Size -> 0x0049 (FullSize[0x0271] - InheritedSize[0x0228])
	 */
	class APRE_MOD_TransferVent_Strait_02_C : public AActor
	{
	public:
	...
	public:
		...
		void GetOcclusion();
		void ExecuteUbergraph_PRE_MOD_TransferVent_Strait_02(int32_t EntryPoint);
