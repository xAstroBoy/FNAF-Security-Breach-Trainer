...
namespace CG
{
	...
	void UDbgGregoryStatesUI_C::ExecuteUbergraph_DbgGregoryStatesUI(int EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function DbgGregoryStatesUI.DbgGregoryStatesUI_C.ExecuteUbergraph_DbgGregoryStatesUI");
		
		UDbgGregoryStatesUI_C_ExecuteUbergraph_DbgGregoryStatesUI_Params params {};
	...
	UClass* UDbgGregoryStatesUI_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass DbgGregoryStatesUI.DbgGregoryStatesUI_C");
		return ptr;
	}
