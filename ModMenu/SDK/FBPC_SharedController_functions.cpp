...
void AFBPC_SharedController_C::PrintDebugSubtitles(const struct FString& inString, bool Force)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.PrintDebugSubtitles");
...
//		struct FString                                     inString                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
//		bool                                               Force                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
void AFBPC_SharedController_C::PrintDebug(const struct FString& inString, bool Force)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.PrintDebug");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.UpdateSubtitles");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.ShowFazwatch");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.HideFazwatch");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.EndPostEventWithSubtitles");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.PostEventWithSubtitles");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.EndSubtitleDisplay");
...
//		class AActor*                                      Actor                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
//		struct FString                                     FallbackSourceString                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
void AFBPC_SharedController_C::BeginSubtitleDisplay(const struct FString& Key, class AActor* Actor, const struct FString& FallbackSourceString, float Duration, float MaxRadiusPercent, bool SanitizeKey, bool HighPriority)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.BeginSubtitleDisplay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.EnsureSubtitles");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.AfterUnpause");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.AfterPause");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.InpActEvt_Pause_K2Node_InputActionEvent_1");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.InpActEvt_LeftShift_K2Node_InputKeyEvent_2");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.InpActEvt_LeftShift_K2Node_InputKeyEvent_1");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.ReceiveBeginPlay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.Click To Unpause");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.OnToggleLocalizationQA");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function FBPC_SharedController.FBPC_SharedController_C.ExecuteUbergraph_FBPC_SharedController");
