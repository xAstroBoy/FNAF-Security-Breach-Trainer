...
// 0x00A0 (FullSize[0x0348] - InheritedSize[0x02A8])
...
public:
	...
	unsigned char                                      UnknownData_LPUF[0x4];                                     // 0x02F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_NoiseMakingTowerDaycareInteractible.BP_NoiseMakingTowerDaycareInteractible_C");
		return ptr;
	}
