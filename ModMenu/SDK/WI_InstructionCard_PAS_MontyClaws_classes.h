...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_MontyClaws.WI_InstructionCard_PAS_MontyClaws_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_MontyClaws(int EntryPoint);
};
