...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FBPH[0x3];                                   // 0x2EED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U9CZ[0x4];                                   // 0x2F1C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
