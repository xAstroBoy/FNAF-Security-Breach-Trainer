...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_8KVT[0x3];                                   // 0x2EED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BOLH[0x4];                                   // 0x2F1C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
