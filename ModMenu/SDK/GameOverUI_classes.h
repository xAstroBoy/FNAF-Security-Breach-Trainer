...
// 0x05E2 (FullSize[0x0812] - InheritedSize[0x0230])
...
public:
	...
	struct FScriptMulticastDelegate                    AnimationDelay;                                            // 0x07E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_PP2D[0x4];                                     // 0x07FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    AnimationDelayFinished;                                    // 0x0800(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass GameOverUI.GameOverUI_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GameOverUI(int EntryPoint);
