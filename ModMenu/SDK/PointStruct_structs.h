...
struct FPointStruct
{
	...
	unsigned char                                      UnknownData_BPIV[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FName                                       POITag_28_6B5CF22742FF1E93C63C89943A839863;                // 0x0020(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
