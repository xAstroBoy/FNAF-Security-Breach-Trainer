...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.SequenceEvent__ENTRYPOINTGameOverUI_1");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.Finished_5F4680854A7842BE2B96888229038873");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.Fade Out Audio");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.BndEvt__RetryButton_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.BndEvt__QuitButton_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.OnFocusLost");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.PreConstruct");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.BndEvt__QuitButton_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.WaitForAnimationDelay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.AnimationDelayHasFinished");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.BndEvt__RetryButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.Tick");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.Construct");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.FocusOnWidgetButton");
...
void UGameOverUI_C::ExecuteUbergraph_GameOverUI(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.ExecuteUbergraph_GameOverUI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.AnimationDelayFinished__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function GameOverUI.GameOverUI_C.AnimationDelay__DelegateSignature");
