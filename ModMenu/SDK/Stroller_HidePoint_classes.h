...
{
public:
	unsigned char                                      UnknownData_PK1V[0x3];                                     // 0x0325(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Stroller_HidePoint.Stroller_HidePoint_C");
		return ptr;
	}
