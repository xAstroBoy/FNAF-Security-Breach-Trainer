...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_00KQ[0xA4];                                  // 0x0334(0x00A4) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_6WMW[0x18];                                  // 0x0578(0x0018) MISSED OFFSET (PADDING)
