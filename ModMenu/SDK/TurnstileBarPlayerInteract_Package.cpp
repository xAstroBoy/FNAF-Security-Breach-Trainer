...
namespace CG
{
	 ...
	 */
	void ATurnstileBarPlayerInteract_C::GetInteractViewAngles(ECameraAngleFlags* AnglesToCheck)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	void ATurnstileBarPlayerInteract_C::GetInteractibleType(EInteractibleType* Type, EInteractiblePressType* PressType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	void ATurnstileBarPlayerInteract_C::CanPlayerInteract(bool* CanInteract, EConditionFailReason* CantReason)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction ATurnstileBarPlayerInteract_C.StaticClass
