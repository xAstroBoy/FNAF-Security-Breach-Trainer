...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass SpiderProjectile.SpiderProjectile_C
	 * Size -> 0x0028 (FullSize[0x0250] - InheritedSize[0x0228])
	 */
	class ASpiderProjectile_C : public AActor
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_SpiderProjectile(int32_t EntryPoint);
