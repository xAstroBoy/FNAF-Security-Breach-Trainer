...
// 0x0148 (FullSize[0x0AC8] - InheritedSize[0x0980])
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass VCartAnimationBlueprint.VCartAnimationBlueprint_C");
		return ptr;
	}
