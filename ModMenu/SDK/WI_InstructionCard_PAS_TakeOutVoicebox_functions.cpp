...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_InstructionCard_PAS_TakeOutVoicebox.WI_InstructionCard_PAS_TakeOutVoicebox_C.Tick");
...
void UWI_InstructionCard_PAS_TakeOutVoicebox_C::ExecuteUbergraph_WI_InstructionCard_PAS_TakeOutVoicebox(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function WI_InstructionCard_PAS_TakeOutVoicebox.WI_InstructionCard_PAS_TakeOutVoicebox_C.ExecuteUbergraph_WI_InstructionCard_PAS_TakeOutVoicebox");
