...
// 0x0550 (FullSize[0x0780] - InheritedSize[0x0230])
...
public:
	...
	unsigned char                                      UnknownData_75QD[0x7];                                     // 0x0281(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RMQG[0x6];                                     // 0x076A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TitleButton.TitleButton_C");
		return ptr;
	}
	...
	void Set_Display(const struct FText& DisplayText);
	...
	void ExecuteUbergraph_TitleButton(int EntryPoint);
