...
// 0x0043 (FullSize[0x026B] - InheritedSize[0x0228])
...
public:
	...
	unsigned char                                      UnknownData_BEZ0[0x4];                                     // 0x0254(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnTeleportFinished;                                        // 0x0258(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PlayerTeleportHandler.PlayerTeleportHandler_C");
		return ptr;
	}
