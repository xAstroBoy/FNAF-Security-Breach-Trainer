...
// 0x04A0 (FullSize[0x0708] - InheritedSize[0x0268])
class UThirdPerson_AnimBP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_9ZNI[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_L3JS[0x3];                                     // 0x0701(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass ThirdPerson_AnimBP.ThirdPerson_AnimBP_C");
		return ptr;
	}
