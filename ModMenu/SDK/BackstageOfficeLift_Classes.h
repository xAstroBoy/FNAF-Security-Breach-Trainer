...
namespace CG
{
	...
	public:
		...
		class UArrowComponent*                                     Unload_Location;                                         // 0x02B0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		Engine_ETimelineDirection                                  Fall_down__Direction_FA142B6F4F52711C889A83B18CDCE4F9;   // 0x02D4(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_LYKI[0x3];                                   // 0x02D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UTimelineComponent*                                  Fall_down;                                               // 0x02D8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		TArray<class UBackstageLiftTarget_C*>                      WeakPointTargets;                                        // 0x02E0(0x0010) Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference, HasGetValueTypeHash
		bool                                                       LiftBusted;                                              // 0x02F0(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_E230[0x7];                                   // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void GetTargets();
		void Fall_down__FinishedFunc();
		void Fall_down__UpdateFunc();
		void Setup_Lift_Targets();
		void Target_Hit(class UBackstageLiftTarget_C* LiftTarget);
		void Set_Moving(bool MovingUp);
		...
		void Teleport_Freddy_into_office(class AMoveableLift_C* Lift, bool Top);
