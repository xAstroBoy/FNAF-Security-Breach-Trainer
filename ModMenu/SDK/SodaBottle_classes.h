...
// BlueprintGeneratedClass SodaBottle.SodaBottle_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass SodaBottle.SodaBottle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_SodaBottle(int EntryPoint);
};
