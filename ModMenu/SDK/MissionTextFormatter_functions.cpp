...
void UMissionTextFormatter_C::GetFormattedText(const struct FText& TaskTitleText, const struct FFNAFMissionState& MissionState, int StateIndex, struct FText* FormattedTaskTitleText)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function MissionTextFormatter.MissionTextFormatter_C.GetFormattedText");
