...
{
public:
	unsigned char                                      UnknownData_SU2C[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HTT4[0x3];                                     // 0x0119(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OMZH[0x6];                                     // 0x013A(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_94HI[0x6];                                     // 0x005A(0x0006) MISSED OFFSET (PADDING)
