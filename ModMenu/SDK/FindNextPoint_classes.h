...
namespace CG
{
	...
	public:
		...
		TArray<int32_t>                                            PossibleLocations;                                       // 0x0128(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		TArray<struct FPointStruct>                                LocalPoints;                                             // 0x0138(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
	...
	public:
		void FindNextPoint(class APawn* ControlledPawn, int32_t CurrentPathIndex, int32_t PreviousPathIndex, bool FinishAtEnd, int32_t* NextPathPointIndex, struct FVector* NextPointLocation, bool* FoundPoint);
