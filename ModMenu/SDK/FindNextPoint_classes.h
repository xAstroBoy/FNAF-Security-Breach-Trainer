...
public:
	...
	TArray<int>                                        PossibleLocations;                                         // 0x0128(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	...
	int                                                NextPathPointIndex;                                        // 0x0150(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass FindNextPoint.FindNextPoint_C");
		return ptr;
	}



	void Find_Next_Point(class APawn* Controlled_Pawn, int CurrentPathIndex, int PreviousPathIndex, bool FinishAtEnd, int* NextPathPointIndex, struct FVector* NextPointLocation, bool* FoundPoint);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_FindNextPoint(int EntryPoint);
};
