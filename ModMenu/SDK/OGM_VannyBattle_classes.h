...
// 0x0150 (FullSize[0x0401] - InheritedSize[0x02B1])
class AOGM_VannyBattle_C : public AMGM_OfficeGameManger_C
{
public:
	unsigned char                                      UnknownData_HHSJ[0x7];                                     // 0x02B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass OGM_VannyBattle.OGM_VannyBattle_C");
		return ptr;
	}
	...
	void OnFailure_D8EC7FD343756DEFCAD9FBBDE672C6F4(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_D8EC7FD343756DEFCAD9FBBDE672C6F4(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
