...
namespace CG
{
	 ...
	 * Size -> 0x12A8 (FullSize[0x1518] - InheritedSize[0x0270])
	 */
	...
	public:
		...
		class FName                                                Phase;                                                   // 0x1504(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
