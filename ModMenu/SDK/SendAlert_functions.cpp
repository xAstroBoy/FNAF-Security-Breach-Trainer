...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SendAlert.SendAlert_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SendAlert.SendAlert_C.ExecuteUbergraph_SendAlert");
