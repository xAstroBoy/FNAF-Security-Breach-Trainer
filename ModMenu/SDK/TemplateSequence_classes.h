...
{
public:
	unsigned char                                      UnknownData_9SSW[0x8];                                     // 0x0228(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D9YP[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YVHC[0x4];                                     // 0x0274(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V0QY[0x8];                                     // 0x0888(0x0008) MISSED OFFSET (PADDING)
