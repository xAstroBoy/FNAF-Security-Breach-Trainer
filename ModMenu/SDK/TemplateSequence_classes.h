...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_8BON[0x8];                                   // 0x0228(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JEBS[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y5TJ[0x4];                                   // 0x0274(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7VWC[0x8];                                   // 0x0888(0x0008) MISSED OFFSET (PADDING)
