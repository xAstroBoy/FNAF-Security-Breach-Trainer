...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_F1IJ[0x8];                                   // 0x0228(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6C1I[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NEKX[0x4];                                   // 0x0274(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_2T8C[0x8];                                   // 0x0888(0x0008) MISSED OFFSET (PADDING)
