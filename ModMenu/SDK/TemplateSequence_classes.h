...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_OI23[0x8];                                   // 0x0228(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AZ41[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5PK0[0x4];                                   // 0x0274(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TMVC[0x8];                                   // 0x0888(0x0008) MISSED OFFSET (PADDING)
