...
{
	TEnumAsByte<SplineFollowDirection_ESplineFollowDirection> Direction;                                                 // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
