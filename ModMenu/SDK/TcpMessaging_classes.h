...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_OKW8[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8NR8[0x3];                                   // 0x0055(0x0003) MISSED OFFSET (PADDING)
