...
// 0x0962 (FullSize[0x0B92] - InheritedSize[0x0230])
...
public:
	...
	unsigned char                                      UnknownData_URB0[0x6];                                     // 0x05BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     SlotForNewGame;                                            // 0x05C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_48OS[0x7];                                     // 0x0609(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FCinematicCutscene                          FNAF_INTRO_mp4;                                            // 0x0610(0x0040) (Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	struct FScriptMulticastDelegate                    IntroPlaying;                                              // 0x0650(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_V8O0[0x4];                                     // 0x0B5C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TitleUI.TitleUI_C");
		return ptr;
	}



	void CreateDeleteList(const struct FString& SaveSlotName, const struct FScriptDelegate& Delegate, bool AutoSave);
	struct FEventReply OnPreviewKeyDown(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent);
	void CreateLoadButton(const struct FString& SaveSlotName, bool IsAutoSave, const struct FScriptDelegate& Delegate);
	void NewGameButton_Visibility(TArray<struct FString> TargetArray);
	...
	void FadeToLoad(const struct FScriptDelegate& Event);
	...
	void Load_Level(const struct FName& InputPin);
