...
namespace CG
{
	 ...
	 */
	void AKitchenBotPizzaStation_C::GetInteractibleType(InteractibleType_EInteractibleType* Type, InteractiblePressType_EInteractiblePressType* PressType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	void AKitchenBotPizzaStation_C::ExecuteUbergraph_KitchenBotPizzaStation(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
