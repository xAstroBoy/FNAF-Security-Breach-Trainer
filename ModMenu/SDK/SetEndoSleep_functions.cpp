...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetEndoSleep.SetEndoSleep_C.ReceiveExecuteAI");
...
void USetEndoSleep_C::ExecuteUbergraph_SetEndoSleep(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetEndoSleep.SetEndoSleep_C.ExecuteUbergraph_SetEndoSleep");
