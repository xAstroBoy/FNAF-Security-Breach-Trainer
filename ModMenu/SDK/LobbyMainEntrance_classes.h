...
public:
	...
	unsigned char                                      UnknownData_6OND[0x7];                                     // 0x0281(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass LobbyMainEntrance.LobbyMainEntrance_C");
		return ptr;
	}
