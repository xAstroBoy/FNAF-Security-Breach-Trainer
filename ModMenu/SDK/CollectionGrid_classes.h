...
public:
	...
	TMap<class UInventoryItemButton_C*, struct FString> ItemInfoMap;                                               // 0x0288(0x0050) (Edit, BlueprintVisible, ContainsInstancedReference)
	...
	unsigned char                                      UnknownData_IYY4[0x3];                                     // 0x02E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CollectionGrid.CollectionGrid_C");
		return ptr;
	}
