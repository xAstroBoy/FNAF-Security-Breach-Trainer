...
namespace CG
{
	...
	public:
		...
		void StaffBot_Spawn();
		void CompletePizza();
		void CompleteCurrentPizzaStep(PizzaStep_EPizzaStep PizzaStep);
		void DebugInit();
		void On_Start();
		void OnFailure_E9643CFF42AA97CD6B19978DBB35F9C7();
		void OnSuccess_E9643CFF42AA97CD6B19978DBB35F9C7();
		void OnFailure_9CEE3F5D496058D0154EDB89656BFCC1(const class FName& WrittenAchievementName, float WrittenProgress, int32_t WrittenUserTag);
		void OnSuccess_9CEE3F5D496058D0154EDB89656BFCC1(const class FName& WrittenAchievementName, float WrittenProgress, int32_t WrittenUserTag);
		...
		void ExecuteUbergraph_OGM_Kitchen(int32_t EntryPoint);
