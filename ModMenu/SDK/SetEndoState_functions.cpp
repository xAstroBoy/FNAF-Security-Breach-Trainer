...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetEndoState.SetEndoState_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetEndoState.SetEndoState_C.ExecuteUbergraph_SetEndoState");
