...
namespace CG
{
	 ...
	 * Size -> 0x0199 (FullSize[0x03C9] - InheritedSize[0x0230])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_DR1W[0x6];                                   // 0x02D2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FX7C[0x7];                                   // 0x0339(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
