...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass WestArcadeHolesManager.WestArcadeHolesManager_C");
		return ptr;
	}
	...
	void Update();
	void ExecuteUbergraph_WestArcadeHolesManager(int EntryPoint);
};
