...
namespace CG
{
	 ...
	 * Size -> 0x0542 (FullSize[0x07B2] - InheritedSize[0x0270])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_P2TN[0x3];                                   // 0x0755(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EBS7[0x4];                                   // 0x075C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U6CU[0x3];                                   // 0x07A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
