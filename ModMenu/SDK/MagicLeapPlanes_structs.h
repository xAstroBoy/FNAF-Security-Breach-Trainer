...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RLII[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_W4PK[0xE];                                   // 0x0052(0x000E) MISSED OFFSET (PADDING)
