...
namespace CG
{
	...
	public:
		...
		TArray<class FName>                                        TapesDonePlaying;                                        // 0x0078(0x0010) Edit, BlueprintVisible, HasGetValueTypeHash
		TArray<class FName>                                        InInventoryTapes;                                        // 0x0088(0x0010) Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash
	...
	public:
		...
		void GetCollectedTapesData(const class FName& InventoryItemName, bool* HasBeenCollected_);
