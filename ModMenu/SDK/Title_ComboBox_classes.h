...
public:
	...
	struct FText                                       TextValue;                                                 // 0x0260(0x0018) (Edit, BlueprintVisible, ExposeOnSpawn)
	TArray<struct FString>                             ComboBoxValues;                                            // 0x0278(0x0010) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	...
	struct FScriptMulticastDelegate                    ChangesApplied;                                            // 0x0290(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    ArrowKeyPressed;                                           // 0x02A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Title_ComboBox.Title_ComboBox_C");
		return ptr;
	}
