...
namespace CG
{
	...
	public:
		...
		Engine_EDrawDebugTrace                                     DrawDebugType;                                           // 0x0001(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
