...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_1K60[0x2];                                   // 0x026E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_CutSceneActor_Staffbot(int32_t EntryPoint);
