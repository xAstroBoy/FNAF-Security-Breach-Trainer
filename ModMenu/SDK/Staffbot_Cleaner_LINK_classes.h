...
// 0x0C3A (FullSize[0x0EA2] - InheritedSize[0x0268])
class UStaffbot_Cleaner_LINK_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_YTCU[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_USWR[0x3];                                     // 0x0E99(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Staffbot_Cleaner_LINK.Staffbot_Cleaner_LINK_C");
		return ptr;
	}
