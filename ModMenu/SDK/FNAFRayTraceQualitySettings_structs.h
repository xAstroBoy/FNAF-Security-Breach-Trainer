...
namespace CG
{
	...
	{
	public:
		FNAFQualityCommands_EFNAFQualityCommands                   QualityCommand_2_C7DD91854562814E8D8E86B7724E319A;       // 0x0000(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_GAHO[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
