...
namespace CG
{
	...
	{
	public:
		bool STATIC_GetClosestPointOnNavigationMesh__Horizontal_(const struct FVector& Location, float EdgePadding, float MaxRadius, float TestIncrement, int32_t AngleResolution, bool VisibleFromLocation, TArray<class AActor*>* ActorsToIgnore, bool DrawDebug, const struct FLinearColor& TraceColor, const struct FLinearColor& TraceHitColor, float DrawTime, class UObject* __WorldContext, struct FVector* ReturnLocation);
