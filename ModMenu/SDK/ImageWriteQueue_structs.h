...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_7UI1[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Z5F2[0x46];                                  // 0x001A(0x0046) MISSED OFFSET (PADDING)
