...
// 0x0052 (FullSize[0x027A] - InheritedSize[0x0228])
...
public:
	...
	unsigned char                                      UnknownData_5RO0[0x3];                                     // 0x025D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PRE_PartsandService_Door.PRE_PartsandService_Door_C");
		return ptr;
	}
