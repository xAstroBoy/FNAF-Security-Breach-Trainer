...
namespace CG
{
	...
	public:
		...
		Engine_ETimelineDirection                                  DoorOpeningTimeline__Direction_33D1055F4EE92B03E7D7BDA5EB032E3F; // 0x025C(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_GVU4[0x3];                                   // 0x025D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void BndEvt__CylinderDoorLock_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
		void PlayOpenSFXStart();
		void PlayOpenSFXEnd();
		void PlayCloseSFXStart();
		void PlayCloseSFXEnd();
		void ExecuteUbergraph_PRE_PartsandService_Door(int32_t EntryPoint);
