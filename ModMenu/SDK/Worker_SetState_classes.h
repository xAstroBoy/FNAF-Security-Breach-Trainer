...
namespace CG
{
	...
	public:
		...
		StaffBotWorkerState_EStaffBotWorkerState                   StaffBotWorkerState;                                     // 0x00D8(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
