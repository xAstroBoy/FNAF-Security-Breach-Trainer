...
struct FLuminComponentSubElement
{
	...
	unsigned char                                      UnknownData_7CM8[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLuminComponentElement
{
	...
	unsigned char                                      UnknownData_C9XT[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
