...
public:
	...
	struct FScriptMulticastDelegate                    GameWon;                                                   // 0x02A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_FlagScore_Fazerblast.WI_FlagScore_Fazerblast_C");
		return ptr;
	}
