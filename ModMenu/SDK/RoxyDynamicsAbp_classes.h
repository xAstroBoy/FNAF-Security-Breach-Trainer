...
// 0x1B54 (FullSize[0x1DBC] - InheritedSize[0x0268])
class URoxyDynamicsABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_S8G1[0x8];                                     // 0x0268(0x0008) Fix Super Size
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0270(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	unsigned char                                      UnknownData_MLGP[0x8];                                     // 0x0278(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VCHZ[0x8];                                     // 0x0DD8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7GMZ[0x8];                                     // 0x1938(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QS7P[0x3];                                     // 0x1DB1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass RoxyDynamicsAbp.RoxyDynamicsABP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_RoxyDynamicsABP(int EntryPoint);
};
