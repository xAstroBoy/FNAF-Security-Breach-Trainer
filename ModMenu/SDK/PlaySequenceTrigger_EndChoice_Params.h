...
namespace CG
{
	...
	{
	public:
		bool                                                       Has_Met_Conditions;                                      // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 ...
	 */
	struct APlaySequenceTrigger_EndChoice_C_On_Sequence_Stop_Event_Params
	{
	};
	 ...
	 */
	struct APlaySequenceTrigger_EndChoice_C_On_Vanny_Intro_Stop_Params
	{
	};
	 ...
	 */
	struct APlaySequenceTrigger_EndChoice_C_On_Teleport_Finished_Params
	{
	};
