...
void APurpleMan_Tape_Actor_C::GetInteractibleType(TEnumAsByte<InteractibleType_EInteractibleType>* Type, TEnumAsByte<InteractiblePressType_EInteractiblePressType>* PressType)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.GetInteractibleType");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.CanPlayerInteract");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.UpdateUIOnTick");
...
void APurpleMan_Tape_Actor_C::GetInstructionOverride(struct FText* Instruction)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.GetInstructionOverride");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.InteractIgnoresTrace");
...
// Parameters:
//		struct FText                                       Instruction                                                (Parm, OutParm)
void APurpleMan_Tape_Actor_C::GetHUDInstruction(struct FText* Instruction)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.GetHUDInstruction");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.GetInteractViewAngles");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.GetInteractViewLocation");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.OnPlayerInteractCancel");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.OnPlayerHoverEnter");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.OnPlayerHoverExit");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.OnPlayerInteract");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.ReceiveBeginPlay");
...
void APurpleMan_Tape_Actor_C::ExecuteUbergraph_PurpleMan_Tape_Actor(int EntryPoint)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PurpleMan_Tape_Actor.PurpleMan_Tape_Actor_C.ExecuteUbergraph_PurpleMan_Tape_Actor");
