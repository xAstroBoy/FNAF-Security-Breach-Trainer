...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_CheckTask.Worker_CheckTask_C.ReceiveTickAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Worker_CheckTask.Worker_CheckTask_C.ExecuteUbergraph_Worker_CheckTask");
