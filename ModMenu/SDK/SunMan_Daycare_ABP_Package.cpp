...
#include "SunMan_Daycare_ABP_Package.h"
...
namespace CG
{
	 ...
	 */
	bool USunMan_Daycare_ABP_C::LineTraceForOrientation(const class FName& InSocketName, const struct FVector& StartOffset, const struct FVector& EndOffset, TEnumAsByte<Engine_EDrawDebugTrace> DrawDebugType, TArray<struct FHitResult>* OutHits)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	bool USunMan_Daycare_ABP_C::LineTraceForIK(const class FName& InSocketName, const struct FVector& StartOffset, const struct FVector& EndOffset, TEnumAsByte<Engine_EDrawDebugTrace> DrawDebugType, struct FHitResult* OutHit)
	{
		static UFunction* fn = nullptr;
		if (!fn)
