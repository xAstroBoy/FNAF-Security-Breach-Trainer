...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NQ3N[0x7];                                   // 0x0291(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnTriggered();
		void ExecuteUbergraph_MainExitMissionTrigger(int32_t EntryPoint);
