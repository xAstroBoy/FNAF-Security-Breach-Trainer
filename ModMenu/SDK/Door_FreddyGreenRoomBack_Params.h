...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Door_FreddyGreenRoomBack.Door_FreddyGreenRoomBack_C.BndEvt__Door_K2Node_ComponentBoundEvent_0_OnPawnExitedDoor__DelegateSignature
	 */
	struct ADoor_FreddyGreenRoomBack_C_BndEvt__Door_K2Node_ComponentBoundEvent_0_OnPawnExitedDoor__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct ADoor_FreddyGreenRoomBack_C_ExecuteUbergraph_Door_FreddyGreenRoomBack_Params
	{
	public:
