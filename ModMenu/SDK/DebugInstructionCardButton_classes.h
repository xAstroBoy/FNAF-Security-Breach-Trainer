...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass DebugInstructionCardButton.DebugInstructionCardButton_C");
		return ptr;
	}
	...
	void Set_Instruction_Card_Button_Text(const struct FText& Button_Text);
