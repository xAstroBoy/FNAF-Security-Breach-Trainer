...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Functions_Traces.Functions_Traces_C.LineTraceByChannelAcrossSurfaces (Conform)");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function Functions_Traces.Functions_Traces_C.LineTraceByChannelAcrossSurfaces (Slide)");
