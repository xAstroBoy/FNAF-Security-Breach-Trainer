...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_TakeOutVoicebox.WI_InstructionCard_PAS_TakeOutVoicebox_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_TakeOutVoicebox(int EntryPoint);
};
