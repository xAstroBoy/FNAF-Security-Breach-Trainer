...
struct FLiveLinkSourceBufferManagementSettings
{
	...
	unsigned char                                      UnknownData_EFWW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TW1S[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YXQH[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RJG4[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WZY4[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2W1G[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_U2ZK[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XRJS[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GD24[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WCDB[0x160];                                   // 0x0000(0x0160) MISSED OFFSET (PADDING)
...
struct FSubjectMetadata
{
	...
	unsigned char                                      UnknownData_EG53[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
struct FLiveLinkBaseFrameData
{
	...
	unsigned char                                      UnknownData_39EP[0x20];                                    // 0x0080(0x0020) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_M0SR[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_05SU[0xB];                                     // 0x00E5(0x000B) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_C6SZ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkLightStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_E11C[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_9BRT[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_0JVB[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkSubjectPreset
{
	...
	unsigned char                                      UnknownData_2H42[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkInterpolationSettings
{
	...
	unsigned char                                      UnknownData_WQOS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkTransformBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_HGW7[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
