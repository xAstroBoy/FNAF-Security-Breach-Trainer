...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_TakeOffBowtie.WI_InstructionCard_PAS_TakeOffBowtie_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_TakeOffBowtie(int EntryPoint);
};
