...
// 0x09AC (FullSize[0x0C14] - InheritedSize[0x0268])
class UStaffbot_Security_LINK_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_IDT2[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_CMRL[0x3];                                     // 0x0BE1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0J9B[0x2];                                     // 0x0BF2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4EUN[0x6];                                     // 0x0C02(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Staffbot_Security_LINK.Staffbot_Security_LINK_C");
		return ptr;
	}
