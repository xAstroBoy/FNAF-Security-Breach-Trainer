...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PlayVO.PlayVO_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PlayVO.PlayVO_C.ExecuteUbergraph_PlayVO");
