...
// BlueprintGeneratedClass PRE_GtrGlf_BarrelToxic.PRE_GtrGlf_BarrelToxic_C
...
public:
	...
	float                                              Subtle_bob_NewTrack_0_2966235B49198575202FF8A614982B85;    // 0x0238(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<Engine_ETimelineDirection>             Subtle_bob__Direction_2966235B49198575202FF8A614982B85;    // 0x023C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_0LYT[0x3];                                     // 0x023D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PRE_GtrGlf_BarrelToxic.PRE_GtrGlf_BarrelToxic_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PRE_GtrGlf_BarrelToxic(int EntryPoint);
};
