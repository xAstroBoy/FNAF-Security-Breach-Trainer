...
// 0x05AC (FullSize[0x0814] - InheritedSize[0x0268])
class UFreddy_Cinematic_Medscan_Abp_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_59U4[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Freddy_Cinematic_Medscan_Abp.Freddy_Cinematic_Medscan_Abp_C");
		return ptr;
	}
