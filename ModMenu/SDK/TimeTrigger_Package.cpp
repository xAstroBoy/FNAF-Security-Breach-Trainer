...
namespace CG
{
	 ...
	 */
	void UTimeTrigger_C::Start_Timer(int Current_Time_Hour, int Current_Time_Minute, int TImer_End_Hour, int Timer_End_Minute, const class FScriptDelegate& Timer_End_Event)
	{
