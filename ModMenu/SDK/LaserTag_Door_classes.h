...
// 0x0053 (FullSize[0x027B] - InheritedSize[0x0228])
...
public:
	...
	TEnumAsByte<Engine_ETimelineDirection>             Open_Door__Close_Door__Direction_0CA022E7445EA752160ECBB57CC51438; // 0x026C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_LM21[0x3];                                     // 0x026D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass LaserTag_Door.LaserTag_Door_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_LaserTag_Door(int EntryPoint);
};
