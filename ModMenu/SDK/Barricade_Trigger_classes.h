...
// BlueprintGeneratedClass Barricade_Trigger.Barricade_Trigger_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Barricade_Trigger.Barricade_Trigger_C");
		return ptr;
	}
