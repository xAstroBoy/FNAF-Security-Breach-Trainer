...
namespace CG
{
	...
	public:
		...
		TArray<class ASplinePathway_C*>                            Splines_7_A2EF2B79492FF7FBD9BD4284FBF7B36F;              // 0x0008(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate
		TArray<class ASplinePathFork_C*>                           OriginalForks_12_7AB1BD93442FC6D177F27EA1E4DCC664;       // 0x0018(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate
	};
