...
public:
	...
	struct FScriptMulticastDelegate                    PowerLevelDispatch;                                        // 0x0260(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_Gregory_Interact.WI_Gregory_Interact_C");
		return ptr;
	}
