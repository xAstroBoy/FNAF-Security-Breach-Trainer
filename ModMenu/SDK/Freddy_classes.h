...
// 0x0206 (FullSize[0x0918] - InheritedSize[0x0712])
class AFreddy_C : public AFirstPersonCharacter_C
{
public:
	unsigned char                                      UnknownData_N95D[0x6];                                     // 0x0712(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<Engine_ETimelineDirection>             Timeline_0_0__Direction_4982063C48B0BDB7171874A857DF95EB;  // 0x07A0(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_P1UI[0x7];                                     // 0x07A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScriptMulticastDelegate                    ExitedSuit;                                                // 0x07E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    EnteredSuit;                                               // 0x07F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                               MenuOpen;                                                  // 0x0808(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_GHYU[0x3];                                     // 0x0809(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CPBB[0x1];                                     // 0x0827(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SAYB[0x6];                                     // 0x0832(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2RX7[0x7];                                     // 0x0849(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U68R[0x7];                                     // 0x0879(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZYL9[0x2];                                     // 0x088A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7DPT[0x4];                                     // 0x08A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DWIG[0x4];                                     // 0x08BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MKJB[0x3];                                     // 0x08E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O2CK[0x6];                                     // 0x08F2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N1YA[0x4];                                     // 0x0904(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UAkAudioEvent*>                       StunVO;                                                    // 0x0908(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Freddy.Freddy_C");
		return ptr;
	}
	...
	void OnNotifyEnd_6D69D7084A234DF6107D8FB1519D5613(const struct FName& NotifyName);
	void OnNotifyBegin_6D69D7084A234DF6107D8FB1519D5613(const struct FName& NotifyName);
	void OnInterrupted_6D69D7084A234DF6107D8FB1519D5613(const struct FName& NotifyName);
	void OnBlendOut_6D69D7084A234DF6107D8FB1519D5613(const struct FName& NotifyName);
	void OnCompleted_6D69D7084A234DF6107D8FB1519D5613(const struct FName& NotifyName);
	void OnNotifyEnd_61E4237F499C97F015561A8B21782BE8(const struct FName& NotifyName);
	void OnNotifyBegin_61E4237F499C97F015561A8B21782BE8(const struct FName& NotifyName);
	void OnInterrupted_61E4237F499C97F015561A8B21782BE8(const struct FName& NotifyName);
	void OnBlendOut_61E4237F499C97F015561A8B21782BE8(const struct FName& NotifyName);
	void OnCompleted_61E4237F499C97F015561A8B21782BE8(const struct FName& NotifyName);
	...
	void SmashAnim();
	void EQS_Finished(class UEnvQueryInstanceBlueprintWrapper* QueryInstance, TEnumAsByte<AIModule_EEnvQueryStatus> QueryStatus);
	...
	void ExecuteUbergraph_Freddy(int EntryPoint);
