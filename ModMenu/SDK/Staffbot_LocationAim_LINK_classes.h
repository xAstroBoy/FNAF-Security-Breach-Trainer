...
// 0x0E09 (FullSize[0x1071] - InheritedSize[0x0268])
class UStaffbot_LocationAim_LINK_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_6595[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_2W1I[0x3];                                     // 0x1051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<StaffbotJob_Anim_EStaffbotJob_Anim>    jobEnum;                                                   // 0x1070(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Staffbot_LocationAim_LINK.Staffbot_LocationAim_LINK_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Staffbot_LocationAim_LINK(int EntryPoint);
};
