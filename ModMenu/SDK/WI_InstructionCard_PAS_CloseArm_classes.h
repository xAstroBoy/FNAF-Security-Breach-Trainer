...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_CloseArm.WI_InstructionCard_PAS_CloseArm_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_CloseArm(int EntryPoint);
};
