...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NH67[0x7];                                   // 0x0279(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnFailure_58B7ED6B4FD53D679070E8A8EA58ADE3(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
		void OnSuccess_58B7ED6B4FD53D679070E8A8EA58ADE3(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
		void OnFailure_BE8F1D784F4D64083536E28939128882(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
		void OnSuccess_BE8F1D784F4D64083536E28939128882(const class FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
