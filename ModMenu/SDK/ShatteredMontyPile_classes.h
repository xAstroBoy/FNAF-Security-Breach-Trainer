...
// 0x00D0 (FullSize[0x02F8] - InheritedSize[0x0228])
...
public:
	...
	unsigned char                                      UnknownData_EP6R[0x7];                                     // 0x0279(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass ShatteredMontyPile.ShatteredMontyPile_C");
		return ptr;
	}
	...
	void OnFailure_58B7ED6B4FD53D679070E8A8EA58ADE3(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_58B7ED6B4FD53D679070E8A8EA58ADE3(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnFailure_BE8F1D784F4D64083536E28939128882(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	void OnSuccess_BE8F1D784F4D64083536E28939128882(const struct FName& WrittenAchievementName, float WrittenProgress, int WrittenUserTag);
	...
	void ExecuteUbergraph_ShatteredMontyPile(int EntryPoint);
};
