...
// 0x0C62 (FullSize[0x0ECA] - InheritedSize[0x0268])
class USunMan_Daycare_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_WPSQ[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	struct FName                                       Spine1_jnt;                                                // 0x0EA0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_SV42[0x1];                                     // 0x0EAB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BSQO[0x3];                                     // 0x0EB1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QN9O[0x2];                                     // 0x0EBE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Phase;                                                     // 0x0EC0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass SunMan_Daycare_ABP.SunMan_Daycare_ABP_C");
		return ptr;
	}
	...
	void OnNotifyEnd_DE44DD3745D008724B66B28647672BDD(const struct FName& NotifyName);
	void OnNotifyBegin_DE44DD3745D008724B66B28647672BDD(const struct FName& NotifyName);
	void OnInterrupted_DE44DD3745D008724B66B28647672BDD(const struct FName& NotifyName);
	void OnBlendOut_DE44DD3745D008724B66B28647672BDD(const struct FName& NotifyName);
	void OnCompleted_DE44DD3745D008724B66B28647672BDD(const struct FName& NotifyName);
	void OnNotifyEnd_9782A5214C2B6830FC0EC9B462FC6F06(const struct FName& NotifyName);
	void OnNotifyBegin_9782A5214C2B6830FC0EC9B462FC6F06(const struct FName& NotifyName);
	void OnInterrupted_9782A5214C2B6830FC0EC9B462FC6F06(const struct FName& NotifyName);
	void OnBlendOut_9782A5214C2B6830FC0EC9B462FC6F06(const struct FName& NotifyName);
	void OnCompleted_9782A5214C2B6830FC0EC9B462FC6F06(const struct FName& NotifyName);
