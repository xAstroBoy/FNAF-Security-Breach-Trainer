...
// 0x0121 (FullSize[0x0351] - InheritedSize[0x0230])
...
public:
	...
	unsigned char                                      UnknownData_AMHL[0x4];                                     // 0x033C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass PauseUI.PauseUI_C");
		return ptr;
	}
