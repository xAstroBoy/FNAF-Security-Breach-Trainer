...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_MissionItem.UI_MissionItem_C");
		return ptr;
	}



	void Update(const struct FText& InText, bool Complete, bool HideTask);
