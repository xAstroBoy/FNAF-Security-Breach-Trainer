...
// 0x007C (FullSize[0x032C] - InheritedSize[0x02B0])
...
public:
	...
	unsigned char                                      UnknownData_FW43[0x7];                                     // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4QP8[0x3];                                     // 0x0321(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass LMMSplinePathwayManager.LMMSplinePathwayManager_C");
		return ptr;
	}
