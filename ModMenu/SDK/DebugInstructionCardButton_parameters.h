...
struct UDebugInstructionCardButton_C_Set_Instruction_Card_Button_Text_Params
{
	struct FText                                       Button_Text;                                               // 0x0000(0x0018)  (BlueprintVisible, BlueprintReadOnly, Parm)
};
