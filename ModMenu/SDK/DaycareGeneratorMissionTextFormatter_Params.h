...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function DaycareGeneratorMissionTextFormatter.DaycareGeneratorMissionTextFormatter_C.GetFormattedText
	 */
	struct UDaycareGeneratorMissionTextFormatter_C_GetFormattedText_Params
	{
	public:
