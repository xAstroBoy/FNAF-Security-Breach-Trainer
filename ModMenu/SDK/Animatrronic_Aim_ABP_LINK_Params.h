...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Animatrronic_Aim_ABP_LINK.Animatrronic_Aim_ABP_LINK_C.AnimGraph
	 */
	struct UAnimatrronic_Aim_ABP_LINK_C_AnimGraph_Params
	{
	public:
	 ...
	 */
	struct UAnimatrronic_Aim_ABP_LINK_C_BlueprintUpdateAnimation_Params
	{
	public:
	 ...
	 */
	struct UAnimatrronic_Aim_ABP_LINK_C_ExecuteUbergraph_Animatrronic_Aim_ABP_LINK_Params
	{
	public:
