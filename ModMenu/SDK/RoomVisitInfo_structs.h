...
namespace CG
{
	...
	public:
		...
		RoomVisitStatus_ERoomVisitStatus                           LastVisited_9_615D533B4E3173E5AAB51B88B997A10E;          // 0x000C(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_6D59[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
