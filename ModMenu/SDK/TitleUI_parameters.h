...
{
	struct FString                                     SaveSlotName;                                              // 0x0000(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	struct FScriptDelegate                             Delegate;                                                  // 0x0010(0x0010)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor)
...
struct UTitleUI_C_CreateLoadButton_Params
{
	...
	struct FScriptDelegate                             Delegate;                                                  // 0x0014(0x0010)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor)
};

// Function TitleUI.TitleUI_C.NewGameButton_Visibility
struct UTitleUI_C_NewGameButton_Visibility_Params
{
	TArray<struct FString>                             TargetArray;                                               // 0x0000(0x0010)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
};
...
{
	int                                                Seed;                                                      // 0x0000(0x0004)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function TitleUI.TitleUI_C.SetSurvivalLives
struct UTitleUI_C_SetSurvivalLives_Params
{
	TEnumAsByte<E_SurvivalLives_E_SurvivalLives>       Value;                                                     // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function TitleUI.TitleUI_C.SetSurvivalTime
struct UTitleUI_C_SetSurvivalTime_Params
{
	int                                                MinutesPerHour;                                            // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
	struct FString                                     SaveSlot;                                                  // 0x0000(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
};
...
{
	int                                                CourseIndex;                                               // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
