...
namespace CG
{
	 ...
	 */
	struct UTitleButton_C_Set_Display_Params
	{
	public:
	...
	/**
	 * Function TitleButton.TitleButton_C.Tick
	 */
	struct UTitleButton_C_Tick_Params
	{
	public:
		struct FGeometry                                           MyGeometry;                                              // 0x0000(0x0038)  (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	...
	/**
	 * Function TitleButton.TitleButton_C.Construct
	 */
	struct UTitleButton_C_Construct_Params
	{
	};
