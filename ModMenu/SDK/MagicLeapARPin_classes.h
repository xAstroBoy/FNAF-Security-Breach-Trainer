...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BFTF[0x2];                                   // 0x020E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HVZN[0xF0];                                  // 0x02C0(0x00F0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KWVC[0x7];                                   // 0x0239(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_W8EL[0x7];                                   // 0x0229(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*>    AllInfoActors;                                           // 0x0230(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_G0PK[0x8];                                   // 0x0280(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UClass*                                              ClassToSpawn;                                            // 0x0288(0x0008) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate
	...
	public:
		...
		unsigned char                                              UnknownData_8BB3[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2S1T[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (PADDING)
