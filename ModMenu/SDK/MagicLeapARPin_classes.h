...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LDG2[0x2];                                   // 0x0206(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6O9Z[0xD0];                                  // 0x0250(0x00D0) MISSED OFFSET (PADDING)
	...
	public:
		...
		MagicLeapARPin_EMagicLeapPassableWorldError STATIC_GetNumAvailableARPins(int32_t* Count);
		MagicLeapARPin_EMagicLeapPassableWorldError STATIC_GetClosestARPin(const struct FVector& SearchPoint, struct FGuid* PinID);
		MagicLeapARPin_EMagicLeapPassableWorldError STATIC_GetAvailableARPins(int32_t NumRequested, TArray<struct FGuid>* Pins);
	...
	public:
		...
		unsigned char                                              UnknownData_DFCP[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KKLG[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
