...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_K3XW[0x4];                                   // 0x00DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void OnMoveFinished_7D0AA3AC4EB43CAA4E635F8BC89D68DB(AIModule_EPathFollowingResult Result, class AAIController* AIController);
