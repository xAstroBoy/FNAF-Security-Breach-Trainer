...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SplineFollowerBase.SplineFollowerBase_C.GetSplineFollowerContext");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SplineFollowerBase.SplineFollowerBase_C.GetPossibleSplinePaths");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SplineFollowerBase.SplineFollowerBase_C.PickRandomFork");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SplineFollowerBase.SplineFollowerBase_C.ReceiveBeginPlay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SplineFollowerBase.SplineFollowerBase_C.Stop at Door");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SplineFollowerBase.SplineFollowerBase_C.Hit Fork");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SplineFollowerBase.SplineFollowerBase_C.On Door Unlocked");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SplineFollowerBase.SplineFollowerBase_C.SetSplineFollowerContext");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SplineFollowerBase.SplineFollowerBase_C.ExecuteUbergraph_SplineFollowerBase");
