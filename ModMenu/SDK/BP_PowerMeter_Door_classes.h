...
public:
	...
	unsigned char                                      UnknownData_S9M7[0x2];                                     // 0x0246(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PowerMeter_Door.BP_PowerMeter_Door_C");
		return ptr;
	}
