...
// 0x0280 (FullSize[0x04A8] - InheritedSize[0x0228])
...
public:
	...
	unsigned char                                      UnknownData_B4I7[0x6];                                     // 0x02EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B66T[0x7];                                     // 0x0331(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TEnumAsByte<E_Elevator_Side_E_Elevator_Side>       P_EnteredSide;                                             // 0x0360(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<E_Elevator_Side_E_Elevator_Side>       P_TargetSide;                                              // 0x0361(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<E_Elevator_MovementMode_E_Elevator_MovementMode> P_MovementMode;                                            // 0x0362(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_K9GB[0x1];                                     // 0x0363(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E7K9[0x7];                                     // 0x0369(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D4O4[0x4];                                     // 0x037C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_38I5[0x3];                                     // 0x03E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                P_Index;                                                   // 0x03E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TEnumAsByte<E_Elevator_Side_E_Elevator_Side>       TargetA;                                                   // 0x03F4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_MDNZ[0x3];                                     // 0x03F5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnWakeupOverlapEntered;                                    // 0x03F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    OnWakeupOverlapLeave;                                      // 0x0408(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_USPY[0x3];                                     // 0x0469(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                LightingLocationA;                                         // 0x046C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int                                                LightingLocationB;                                         // 0x0470(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_2NME[0x4];                                     // 0x0474(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScriptMulticastDelegate                    OnButtonPressed;                                           // 0x0478(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	unsigned char                                      UnknownData_CL9G[0x6];                                     // 0x048A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PRE_Elevator_General.PRE_Elevator_General_C");
		return ptr;
	}
	...
	void CloseOrOpenDoors(TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, bool Open);
	void PrintDebugVariable(const struct FString& Description, const struct FString& Variable, TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, bool Remote, bool ShowSide, bool ShowRemote);
	void GetTarget_StreamViewpoint(TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, bool Remote, class AA_Elevator_StreamViewpoint_C** StreamViewpoint);
	void GetTarget_Levels(TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, bool Remote, struct FS_Elevator_Levels* Levels);
	void GetTarget_ArrowIndicators(bool Remote, TArray<class ABP_ArrowIndicator_C*>* ArrowIndicators);
	void GetTarget_Doors(TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, bool Remote, TArray<class APRE_ElevatorDoor_Master_C*>* Doors);
	void GetTarget_Buttons(bool Remote, TArray<class AButtonBase_C*>* Buttons);
	void PrintDebug(const struct FString& inString, TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, bool ShowSide);
	void SetStreamViewpoint(TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, bool Remote, bool bEnable);
	...
	void SetArrowIndicators(bool Remote, TEnumAsByte<E_Elevator_ArrowIndicator_Type_E_Elevator_ArrowIndicator_Type> Type);
	void TeleportPlayer();
	void ToggleLockButtons(bool Remote, bool Lock);
	void ToggleLockDoors(TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, bool Remote, bool Lock, bool Force);
	...
	void ForceDoorOpen();
	void WakeupOverlapBegin(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	void SetLocked(TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, bool Remote, bool Lock);
	void SetLockedAll(bool Remote, bool Lock);
	void ForceDoorClose();
	void ToggleMovement(bool bEnabled);
	void WakeupOverlapEnd(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex);
	void OnPawnEntered(TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, class APawn* Pawn);
	void OnButtonInteract();
	void OnPawnExited(TEnumAsByte<E_Elevator_Side_E_Elevator_Side> Side, class APawn* Pawn);
	void ElevatorSequenceEnd();
	void SwapLevels();
	void OnMovementReachedTargetValue(TEnumAsByte<E_Elevator_MovementMode_E_Elevator_MovementMode> Selection);
	void OnLevelsSwapped();
	void OverlapWake(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	void OverlapSleep(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex);
	...
	void BndEvt__InsideOverlap_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	void BndEvt__InsideOverlap_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex);
	...
	void ExecuteUbergraph_PRE_Elevator_General(int EntryPoint);
	void OnButtonPressed__DelegateSignature();
	void OnWakeupOverlapEntered__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	void OnWakeupOverlapLeave__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex);
};
