...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.GetPointColor");
...
TArray<struct FText> APatrolPath_C::GetAvailablePointTypes()
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.GetAvailablePointTypes");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.GetPointType");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.AddPoint");
...
// Parameters:
//		int                                                PointIndex                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
//		TArray<int>                                        ReturnValue                                                (Parm, OutParm, ReturnParm, HasGetValueTypeHash)
TArray<int> APatrolPath_C::GetPointsConnectedTo(int PointIndex)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.GetPointsConnectedTo");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.GetNumberOfPathPoints");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.GetPointLocation");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.RemovePointInternal");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.ReceiveBeginPlay");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.SetPointLocation");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.AddPointConnection");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.RemovePoint");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.RemovePointConnection");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.SetPointType");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PatrolPath.PatrolPath_C.ExecuteUbergraph_PatrolPath");
