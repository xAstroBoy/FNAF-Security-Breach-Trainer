...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WI_InstructionCard_PAS_ChicaVoicebox.WI_InstructionCard_PAS_ChicaVoicebox_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WI_InstructionCard_PAS_ChicaVoicebox(int EntryPoint);
};
