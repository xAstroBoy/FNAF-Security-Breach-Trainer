...
// 0x003B (FullSize[0x02E8] - InheritedSize[0x02AD])
class ASecurityScreenDisplay_C : public ASecurityScreenDisplayBase_C
{
public:
	unsigned char                                      UnknownData_QSOE[0x3];                                     // 0x02AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass SecurityScreenDisplay.SecurityScreenDisplay_C");
		return ptr;
	}
	...
	void PlayEmitter();
	void StopEmitter();
	void ExecuteUbergraph_SecurityScreenDisplay(int EntryPoint);
};
