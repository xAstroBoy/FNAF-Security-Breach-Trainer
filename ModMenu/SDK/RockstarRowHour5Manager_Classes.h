...
namespace CG
{
	 ...
	 * Size -> 0x00E9 (FullSize[0x0311] - InheritedSize[0x0228])
	 */
	...
	public:
		...
		class UTimeCheckComponent_C*                               TimeCheckComponentFOr;                                   // 0x0238(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		TArray<class AStaffBotBase_C*>                             SpawnedStaffBots;                                        // 0x02F0(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance, HasGetValueTypeHash
		TArray<fnaf9_EFNAFAISpawnType>                             VanessaAlertTypes;                                       // 0x0300(0x0010) Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash
	...
	public:
		...
		void On_Roxy_Left(class AActor* DestroyedActor);
		void On_Package_Collected();
		void BndEvt__ExitChicaRoomTrigger_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
