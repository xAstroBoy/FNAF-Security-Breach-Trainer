...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass ReverseSplineDirection.ReverseSplineDirection_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_ReverseSplineDirection(int EntryPoint);
};
