...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function StopAlert.StopAlert_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function StopAlert.StopAlert_C.ExecuteUbergraph_StopAlert");
