...
namespace CG
{
	 ...
	 * Size -> 0x0120 (FullSize[0x0348] - InheritedSize[0x0228])
	 */
	...
	public:
		...
		class FName                                                CollectMissionName;                                      // 0x02E8(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
