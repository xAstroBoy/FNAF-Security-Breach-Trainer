...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetString.SetString_C.ReceiveExecuteAI");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function SetString.SetString_C.ExecuteUbergraph_SetString");
