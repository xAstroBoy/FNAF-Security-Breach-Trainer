...
// 0x00EA (FullSize[0x0312] - InheritedSize[0x0228])
...
public:
	...
	TEnumAsByte<PizzaStep_EPizzaStep>                  PizzaStep;                                                 // 0x02C0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_VG7M[0x7];                                     // 0x02C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       P_StationName;                                             // 0x02C8(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	unsigned char                                      UnknownData_VEMT[0x6];                                     // 0x02E2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass KitchenBotPizzaStation.KitchenBotPizzaStation_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_KitchenBotPizzaStation(int EntryPoint);
};
