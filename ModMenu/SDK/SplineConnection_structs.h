...
namespace CG
{
	...
	public:
		...
		SplineFollowDirection_ESplineFollowDirection               Direction_12_F4BCD4E44AE4223437C5BD8CAE3A2989;           // 0x0038(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
