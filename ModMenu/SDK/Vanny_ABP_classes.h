...
// 0x2FC8 (FullSize[0x3230] - InheritedSize[0x0268])
class UVanny_ABP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_T95I[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_9QLY[0x8];                                     // 0x0E48(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N2FI[0x8];                                     // 0x1AA8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_17GK[0x8];                                     // 0x23D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YVL0[0x3];                                     // 0x3135(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0808[0x3];                                     // 0x313D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I6FX[0x3];                                     // 0x3199(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7TRS[0x3];                                     // 0x31B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DJEC[0xC];                                     // 0x31C4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1YF2[0x1];                                     // 0x320B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TN7U[0x3];                                     // 0x3215(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FBXN[0x2];                                     // 0x3222(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass Vanny_ABP.Vanny_ABP_C");
		return ptr;
	}
	...
	void OnNotifyEnd_515640F949B4EDD981CE18B0311FE3C4(const struct FName& NotifyName);
	void OnNotifyBegin_515640F949B4EDD981CE18B0311FE3C4(const struct FName& NotifyName);
	void OnInterrupted_515640F949B4EDD981CE18B0311FE3C4(const struct FName& NotifyName);
	void OnBlendOut_515640F949B4EDD981CE18B0311FE3C4(const struct FName& NotifyName);
	void OnCompleted_515640F949B4EDD981CE18B0311FE3C4(const struct FName& NotifyName);
