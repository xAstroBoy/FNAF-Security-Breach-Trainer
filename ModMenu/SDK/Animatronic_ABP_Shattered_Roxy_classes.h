...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_DV20[0x7];                                   // 0x8E09(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Animatronic_ABP_Shattered_Roxy(int32_t EntryPoint);
