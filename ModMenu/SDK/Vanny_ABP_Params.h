...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Vanny_ABP.Vanny_ABP_C.GetMoveSpeedInput
	 */
	struct UVanny_ABP_C_GetMoveSpeedInput_Params
	{
	public:
	 ...
	 */
	struct UVanny_ABP_C_PerformFootIK_Params
	{
	public:
	...
	public:
		bool                                                       Off;                                                     // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_FVOY[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UVanny_ABP_C_SpotlightAimActor_Params
	{
	public:
	...
	/**
	 * Function Vanny_ABP.Vanny_ABP_C.IsHangingEvent
	 */
	struct UVanny_ABP_C_IsHangingEvent_Params
	{
	public:
	...
	/**
	 * Function Vanny_ABP.Vanny_ABP_C.OverlappingDoor
	 */
	struct UVanny_ABP_C_OverlappingDoor_Params
	{
	public:
		bool                                                       Overlapping;                                             // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_NMPQ[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UVanny_ABP_C_StunEvent_Params
	{
	public:
