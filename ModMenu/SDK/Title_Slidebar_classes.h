...
public:
	...
	struct FText                                       Slider_Text;                                               // 0x0260(0x0018) (Edit, BlueprintVisible, ExposeOnSpawn)
	struct FScriptMulticastDelegate                    SliderValueChanged;                                        // 0x0278(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Title_Slidebar.Title_Slidebar_C");
		return ptr;
	}
